...
redirect_from:
  ...
  - /knowledge/invest/2026/05/29/semiconductor-sector-outlook-2026.html
description: "2026년 5월 30일 반도체 섹터 전망. 삼성전자 HBM4E 12단 세계 최초 출하(5/29). KOSPI 8,476 ATH(5/29). 젠슨황 한국 방문 6/5 확정(4대그룹 총수 회동). SI 섹터 AI재평가(삼성SDS+20%, LG CNS+26%, 현대오토에버+24%). Dell AI서버 Q1 FY27 블로우아웃(AI서버 $16.1B +757%). AI 메모리 수요 구조적 강세 2028년까지(HBM 공급 부족)."
...
**5월 30일 핵심 (오늘):**
- **★★★ 삼성전자 HBM4E 12단 세계 최초 출하 (5/29)**: 핀속도 **14→16Gbps(+20% 이상)**, 용량 **48GB**. SK하이닉스 HBM4E는 2026년말 예정 → 삼성이 **6~9개월 선도**. 마이크론 HBM4E는 2027년. 삼성전자 주가 **+6%** 반응. **의미**: HBM3E 열세에서 HBM4→HBM4E 세대 전환 주도권 확보
- **★★★ KOSPI 8,476 ATH (5/29 종가)**: 삼성전기 **+15%**(200만원 돌파, 시총 4위). LG이노텍 **+28%**. 삼성SDS **+20%**. 현대오토에버 **+24%**. LG CNS **+26%**. **SI 섹터 AI재평가**: AX(AI Transformation) 사업 — 삼성SDS·LG CNS·현대오토에버가 새 수혜군으로 부각. AI 기판(FCBGA) 수혜: 삼성전기·LG이노텍·대덕전자·심텍
- **★★★ 젠슨황 한국 방문 6/5 확정**: GTC 타이베이 6/1 키노트 후 한국 방문. 4대 그룹 총수 회동(SK 최태원·LG 구광모·삼성 이재용·현대 CEO). **물리적 AI(피지컬 AI)** — 반도체 너머 자동차·가전·플랫폼으로 AI 확장 논의
- **★★★ Computex 6/1 (내일)**: Jensen Huang GTC 타이베이 키노트 6/1. Lisa Su(AMD), Lip-Bu Tan(Intel) CEO 총집결. **NVDA Vera Rubin GPU/CPU 발표 예정**
- **★★★ AI 메모리 수요 구조적 강세 (김장열)**: 3대 키워드 **추론(Inference) + 에이전트(Agent) + 컨텍스트(Context)**. HBM 공급 부족 최소 **2028년까지** 지속. 마이크론 목표가: UBS $1,625, 현실적 **$1,200**(PER 11~12배). 삼성전자 우선주 괴리율 역사적 평균 16.5% → 현재 **36.5%**로 확대 (매수 기회)
- **★★★ 이경민(대신증권) 반도체 전망**: KOSPI 선행 PER **8.16배** (역사 평균 9.5배 대비 저평가). 9.5배 적용 시 코스피 **9,500**, 10배 시 **10,000+**. **6~8월 강세 지속** 전망
- **★★★ 박병창 반도체 사이클 분석**: 자본시장 기준 AI 인프라 사이클 **50~70% 진행**. 젠슨황 순서: 에너지 인프라→인프라스트럭처→칩→모델→애플리케이션. ETF 잔고 **300조→500조**(수급 구조 변화, 상승 추세 강화)
- **★★ MSCI 선진국 지수 6월 발표**: 한국 워치리스트 편입 여부 6월 발표. 편입 시 코스피 **9,000 조기 달성** 예상
- **★★ PCE 3.8% + Fed 금리인상 50% 위험**: 반도체 상승에도 불구하고 금리 리스크 상존. CME FedWatch 12월 인상 확률 **~57%**. 이경민: 8~9월 잭슨홀+FOMC에서 조정 가능성 → **지금은 풀베팅**

**5월 29일 핵심:**
- **★★★ Dell AI 서버 Q1 FY27 블로우아웃**: 매출 **$43.8B(+88% YoY**, vs 예상 $35.43B). AI 서버 매출 **$16.1B(+757% YoY)**. EPS **$4.86**(vs 예상 $2.88, **+69% 서프라이즈**). FY27 AI 서버 가이던스 **$60B(+$10B 상향)**. 시간외 **+30%**, 종가 **+32%**, AH **+39%**. → AI 인프라 수요 폭발 구조적 확인 → HBM/메모리/GPU 수요 직결
...
## 반도체 섹터 현황 (2026년 5월 30일 기준)

### 핵심 지표

| 항목 | 수치/현황 | 비고 |
|------|----------|------|
| **SOXX** | **$569.08 (-0.07%, 5/29)** | 반도체 섹터 대표 ETF |
| **BOTZ** | **$40.15 (-0.32%, 5/29)** | AI·로보틱스 ETF |
| **S&P 500** | **7,563.63 (5/29)** | 미국 대형주 지수 |
| **NASDAQ** | **26,917.47 (5/29)** | 기술주 지수 |
| **KOSPI** | **8,476 ATH (5/29 종가)** | 삼성전기+15%, LG이노텍+28%, 삼성SDS+20%, LG CNS+26% |
| **삼성전자** | **HBM4E 12단 세계 최초 출하(5/29). +6%** | 핀속도 14→16Gbps(+20%), 용량 48GB. SK하이닉스보다 6~9개월 선도 |
| **NVIDIA** | **~$215. BofA 목표가 $350. GTC 타이베이 6/1** | Vera Rubin: 학습 3.5배·추론 5배·비용 1/7. 메모리 원가 25%. 젠슨황 한국 6/5 방문 확정 |
...
| **SK하이닉스** | **시총 $1T(국내 최초). iHBM. HBM 3년 솔드아웃** | LTA → PER 15배 적용(UBS). 노무라 400만원. 삼성증권 KOSPI 11,000(400만원 내포). HBM4E 2026년말 예정 |
| **삼성전자** | **HBM4E 12단 세계 최초. 목표가 컨센 39만원** | 세대 전환 주도권 확보. 노무라 59만원. 삼성증권 KOSPI 11,000(59만원 내포) |
| **삼성전기** | **200만원 돌파(+15%). 시총 4위** | 실리콘 커패시터(마벨, 1.6조) + MLCC + AI기판(FCBGA). 28년 영업이익 3.3~3.9조, P/E 50배 |
| **LG이노텍** | **+28% (5/29)** | AI 기판(FCBGA) + CPU 기판 수혜. SI 섹터 AI재평가 |
| **삼성SDS** | **+20% (5/29)** | SI 섹터 AI재평가. AX(AI Transformation) 사업 부각 |
| **LG CNS** | **+26% (5/29)** | SI 섹터 AI재평가. AX 사업 수혜군 |
| **현대오토에버** | **+24% (5/29)** | SI 섹터 AI재평가. AX 사업 수혜군 |
| **Dell(DELL)** | **+32%(종가), +39%(AH). FY27 AI서버 가이던스 $60B** | Q1 FY27 AI서버 $16.1B(+757%), EPS $4.86(+69%). AI 인프라 수요 폭발 확인 |
...
| **CME FedWatch** | **12월 금리인상 확률 ~57%** | PCE 3.8%, 반도체 상승에도 금리 리스크 상존 |

### 5월 30일 핵심 업데이트

| 항목 | 내용 |
|------|------|
| **★★★ 삼성전자 HBM4E 12단 세계 최초 출하** | 핀속도 **14→16Gbps(+20% 이상)**, 용량 **48GB**. SK하이닉스 HBM4E는 2026년말 예정 → 삼성이 **6~9개월 선도**. 마이크론 HBM4E는 2027년. 삼성전자 주가 **+6%** 반응. **의미**: HBM3E 열세에서 HBM4→HBM4E 세대 전환 주도권 확보 |
| **★★★ KOSPI 8,476 ATH (5/29 종가)** | 삼성전기 **+15%**(200만원 돌파, 시총 4위). LG이노텍 **+28%**. 삼성SDS **+20%**. 현대오토에버 **+24%**. LG CNS **+26%**. **SI 섹터 AI재평가**: AX(AI Transformation) 사업 — 삼성SDS·LG CNS·현대오토에버가 새 수혜군으로 부각. AI 기판(FCBGA) 수혜: 삼성전기·LG이노텍·대덕전자·심텍 |
| **★★★ 젠슨황 한국 방문 6/5 확정** | GTC 타이베이 6/1 키노트 후 한국 방문. 4대 그룹 총수 회동(SK 최태원·LG 구광모·삼성 이재용·현대 CEO). **물리적 AI(피지컬 AI)** — 반도체 너머 자동차·가전·플랫폼으로 AI 확장 논의 |
| **★★★ Computex 6/1 (내일) GTC 타이베이** | Jensen Huang 키노트 **6/1**. Lisa Su(AMD), Lip-Bu Tan(Intel) CEO 총집결. **NVDA Vera Rubin GPU/CPU 발표 예정** |
| **★★★ AI 메모리 수요 구조적 강세 (김장열)** | 3대 키워드 **추론(Inference) + 에이전트(Agent) + 컨텍스트(Context)**. HBM 공급 부족 최소 **2028년까지** 지속. 마이크론 목표가: UBS $1,625, 현실적 **$1,200**(PER 11~12배). 삼성전자 우선주 괴리율 역사 평균 16.5% → 현재 **36.5%**로 확대 (매수 기회) |
| **★★★ 이경민(대신증권) 반도체 전망** | KOSPI 선행 PER **8.16배** (역사 평균 9.5배 대비 저평가). 9.5배 적용 시 코스피 **9,500**, 10배 시 **10,000+**. **6~8월 강세 지속** 전망 |
| **★★★ 박병창 반도체 사이클 분석** | 자본시장 기준 AI 인프라 사이클 **50~70% 진행**. 젠슨황 순서: 에너지 인프라→인프라스트럭처→칩→모델→애플리케이션. ETF 잔고 **300조→500조**(수급 구조 변화, 상승 추세 강화) |
| **★★ MSCI 선진국 지수 6월 발표** | 한국 워치리스트 편입 여부 6월 발표. 편입 시 코스피 **9,000 조기 달성** 예상 |
| **★★ PCE 3.8% + Fed 금리인상 리스크** | 반도체 상승에도 금리 리스크 상존. CME FedWatch 12월 인상 확률 **~57%**. 이경민: 8~9월 잭슨홀+FOMC에서 조정 가능성 → **지금은 풀베팅** |
...
## 삼성전자 HBM4E 12단 세계 최초 출하 — 세대 전환 주도권 확보 (5/30 업데이트)

삼성전자가 HBM4E 12단 메모리를 세계 최초로 샘플 출하하며, HBM3E에서의 열세를 딛고 HBM4→HBM4E 세대 전환에서 주도권을 확보했습니다.

| 항목 | 내용 |
|------|------|
| **세대 전환** | HBM4E **12단** 샘플 출하 — **세계 최초** |
| **핀속도 개선** | **14 → 16Gbps (+20% 이상)** |
| **용량** | **48GB** |
| **SK하이닉스 HBM4E** | 2026년말 예정 → 삼성이 **6~9개월 선도** |
| **마이크론 HBM4E** | **2027년** 예정 |
| **주가 반응** | 삼성전자 **+6%** |
| **HBM 경쟁구도 변화** | HBM3E: SK하이닉스 우위 → HBM4: 삼성 추격(NVDA 30%+) → **HBM4E: 삼성 선도** |

**투자 시사점**: 삼성전자의 HBM4E 12단 세계 최초 출하는 HBM3E 열세에서 빠르게 탈피해 차세대 세대에서 선도 위치를 확보한 것입니다. SK하이닉스가 6~9개월 뒤처지고 마이크론은 2027년으로 예정된 상황에서, 삼성전자 HBM4E의 빅테크 채용 확률이 높아졌습니다. 특히 NVDA Vera Rubin 및 차세대 AI 칩의 HBM4E 수요가 2027년에 집중될 예정으로, 삼성전자의 선행 출하는 구조적 점유율 확대의 기회입니다.

---

## SI 섹터 AI재평가 — AX(AI Transformation) 新수혜군 부각 (5/30 업데이트)

KOSPI 8,476 ATH(5/29 종가)에서 반도체 대형주를 넘어 SI(시스템통합) 및 AI 기판 섹터가 대규모 재평가를 받았습니다. AI가 하드웨어를 넘어 실제 기업 비즈니스 전환(AX)으로 확산되는 국면입니다.

### SI 섹터 AI재평가 (5/29 종가)

| 종목 | 주가 상승률 | 투자 포인트 |
|------|-----------|-----------|
| **삼성SDS** | **+20%** | AX(AI Transformation) 사업. 삼성그룹 AI 전환 허브 |
| **LG CNS** | **+26%** | AX 사업. LG그룹 AI 전환 플랫폼 |
| **현대오토에버** | **+24%** | AX 사업. 현대그룹 자동차·모빌리티 AI 전환 |

**AX 의미**: AI Transformation — 기업이 AI를 내부 비즈니스에 적용하는 디지털 전환. 단순 SW가 아닌 AI 기반의 전면적 업무 재설계. 젠슨황의 "피지컬 AI" 개념과 맞닿아 있음.

### AI 기판(FCBGA) 섹터 급등 (5/29 종가)

| 종목 | 주가 상승률 | 투자 포인트 |
|------|-----------|-----------|
| **삼성전기** | **+15%** (200만원 돌파, **시총 4위**) | AI 기판(FCBGA) + 실리콘 커패시터 + MLCC 삼각 성장 |
| **LG이노텍** | **+28%** | AI 기판(FCBGA) + CPU 기판 수혜 |
| **대덕전자** | 급등 | AI 기판·PCB 수혜 |
| **심텍** | 급등 | 기판 소재 수혜 |

**투자 시사점**: 젠슨황의 피지컬 AI 비전(자동차·가전·플랫폼 AI 확장)과 SI 기업의 AX 사업 확대는 반도체 HBM 수요와 별도로 새로운 수혜 계층을 형성합니다. 삼성SDS·LG CNS·현대오토에버는 각 그룹의 AI 전환을 담당하는 핵심 엔진으로, 빅테크 AI CapEx $745B가 실제 기업 현장에 도달하는 접점입니다.

---

## AI 메모리 수요 구조적 강세 — 추론·에이전트·컨텍스트 3대 키워드 (5/30 업데이트)

김장열 분석에 따르면 AI 메모리 수요를 이끄는 3대 키워드는 **추론(Inference) + 에이전트(Agent) + 컨텍스트(Context)**입니다.

| 키워드 | 의미 | HBM 수요 영향 |
|--------|------|-------------|
| **추론(Inference)** | 학습에서 추론으로 AI 수요 중심 이동 | 추론 시 대량 메모리 상시 소비 |
| **에이전트(Agent)** | 자율 AI 에이전트 24시간 상시 실행 | CPU+메모리 상시 소비 구조 |
| **컨텍스트(Context)** | 모델 컨텍스트 길이 증가(100K→1M 토큰+) | 컨텍스트 처리 위해 HBM 수요 기하급수적 증가 |

| 항목 | 내용 |
|------|------|
| **HBM 공급 부족** | 최소 **2028년까지** 지속 |
| **마이크론 목표가 (UBS)** | **$1,625** |
| **마이크론 목표가 (현실적)** | **$1,200** (PER 11~12배) |
| **삼성전자 우선주 괴리율** | 역사적 평균 **16.5%** → 현재 **36.5%** (매수 기회) |
| **이경민(대신증권) KOSPI 전망** | 선행 PER 8.16배 → 9.5배 시 **코스피 9,500**, 10배 시 **10,000+** |
| **박병창 AI 사이클 진행률** | 자본시장 기준 **50~70% 진행** — 아직 반 이상 남음 |
| **ETF 잔고 변화** | **300조 → 500조** (수급 구조 변화, 상승 추세 강화) |

**투자 시사점**: 에이전트 AI가 확산될수록 메모리 수요는 구조적으로 증가합니다. 사람이 쉬어도 AI 에이전트는 24시간 실행하며 메모리를 소비합니다. 컨텍스트 길이 증가는 HBM 수요를 선형이 아닌 기하급수적으로 늘립니다. KOSPI 선행 PER 8.16배는 역사 평균 9.5배 대비 저평가로, 이경민의 6~8월 강세 지속 전망과 박병창의 "사이클 50~70% 진행" 분석은 추가 상승 여력이 충분함을 시사합니다.
...
**SI 섹터 AI재평가 (AX 사업 新수혜군)**

| 종목 | 현황 | 비고 |
|------|------|------|
| **삼성SDS** | **+20% (5/29)** | AX(AI Transformation) 사업. 삼성그룹 AI 전환 허브. 젠슨황 피지컬 AI 수혜 |
| **LG CNS** | **+26% (5/29)** | AX 사업. LG그룹 AI 전환 플랫폼 |
| **현대오토에버** | **+24% (5/29)** | AX 사업. 현대그룹 자동차·모빌리티 AI 전환 |

**소부장/기판 (AI 기판 + CPU기판)**

| 종목 | 현황 | 비고 |
|------|------|------|
| **LG이노텍** | **+28% (5/29)** | AI 기판(FCBGA) + CPU 기판 이중 수혜. GPU→전력기기→반도체→CPU 기판 순서 |
| **삼성전기** | **200만원 돌파(+15%, 시총 4위)** | AI 기판(FCBGA) + CPU 기판 + 실리콘 커패시터 삼중 수혜. 목표가 200만원 |
| **심텍** | +20% | CPU 기판/반도체 소재 수혜 |
| **대덕전자** | 랠리 중 | AI 기판·CPU 기판 수혜 |
| **아모텍** | 랠리 중 | CPU 기판 수혜 |
...
| **NASDAQ** | **26,917.47 (5/29)** | 기술주 지수 |
| **KWEB** | **$26.66 (5/29)** | 중국 빅테크/AI 섹터 ETF |
| **KOSPI** | **8,476 ATH (5/29 종가)** | 삼성전기+15%, LG이노텍+28%, SI 섹터 AI재평가 |
| **NVIDIA** | **~$215. BofA 목표가 $350. GTC 타이베이 6/1** | Vera Rubin: 학습 3.5배·추론 5배·비용 1/7. 젠슨황 한국 6/5 방문 확정 |
| **Micron** | **$1조 클럽. Forward PER 8배. UBS 목표가 $1,625** | Q2 매출 $23.86B, 마진 75%, EPS $12.20(+41%). Q3 어닝콜 6/24 |
| **Dell(DELL)** | **+32%(종가), +39%(AH). 가이던스 $60B** | Q1 FY27 AI서버 $16.1B(+757%). AI 인프라 수요 폭발 구조적 확인 |
...
| **SK하이닉스** | **시총 $1T(국내 최초). iHBM. HBM 3년 솔드아웃** | LTA PER 15배(UBS). 노무라 400만원. HBM4E 2026년말 예정 |
| **삼성전자** | **HBM4E 12단 세계 최초(5/29), +6%** | HBM4E 세대 전환 주도권. 노무라 59만원 |
| **삼성전기** | **200만원 돌파(+15%), 시총 4위** | FCBGA + 실리콘 커패시터 + MLCC + CPU기판 |
| **삼성SDS** | **+20% (5/29)** | SI 섹터 AI재평가. AX(AI Transformation) 사업 부각 |
| **LG CNS** | **+26% (5/29)** | SI 섹터 AI재평가. AX 사업 수혜 |
| **현대오토에버** | **+24% (5/29)** | SI 섹터 AI재평가. AX 사업 수혜 |
...
| **KOSPI 선행 PER** | **8.16배** (역사 평균 9.5배 대비 저평가) | 이경민: 9.5배 시 9,500, 10배 시 10,000+ |
| **CME FedWatch** | **12월 금리인상 확률 ~57%** | PCE 3.8%, 8~9월 잭슨홀+FOMC 조정 가능성 |
...
| 전략 | 내용 |
|------|------|
| **단기 (1-2주)** | **GTC 타이베이 6/1 + Computex** — Jensen Vera Rubin 스펙 공개. 6/2 Jensen+Marvell 기조연설: AI 연결성. **6/5 젠슨황 한국 방문**: 4대 그룹 총수 회동 → 피지컬 AI 수혜 구체화. **삼성 HBM4E 세계 최초** 수혜 지속. **MSCI 6월 발표** 주시. SI 섹터 AI재평가(삼성SDS·LG CNS·현대오토에버) 모멘텀 지속 여부 |
...
| 일정 | 내용 | 중요도 |
|------|------|--------|
| **2026년 6/1** | **GTC 타이베이 (Computex)** — Jensen Huang 키노트. NVDA Vera Rubin 상세 발표. AMD Lisa Su·Intel Lip-Bu Tan CEO 참석 | **최고** |
| **2026년 6/2** | **Jensen Huang + Marvell CEO 공동 기조연설** — "AI의 미래는 연결성". CPO 테마 | **최고** |
| **2026년 6/5** | **젠슨황 한국 방문** — 4대 그룹 총수 회동(SK·LG·삼성·현대). 피지컬 AI 논의 | **최고** |
| **2026년 6월** | **MSCI 선진국 지수 발표** — 한국 워치리스트 편입 여부. 편입 시 코스피 9,000 조기 달성 | **최고** |
...
| **2026년 내** | **삼성 파운드리 2nm 고객 수주 발표** | **최고** |
...
| **8~9월** | **잭슨홀+FOMC** — 이경민 조정 가능성 경고. 금리인상 현실화 여부 확인 | 높음 |
| **2026년말** | **SK하이닉스 HBM4E 양산** — 삼성 HBM4E보다 6~9개월 후행 | 높음 |
| **H2 2026** | 구글 TPU 수익화. 삼성SDS·LG CNS·현대오토에버 AX 사업 실적 가시화 | 높음 |
...
| 리스크 | 현황 | 평가 |
|--------|------|------|
| **★★★ KOSPI 반도체 극단 쏠림** | 삼성+SK하이닉스 비중 **50% 돌파**. KOSPI 8,476 ATH에서도 쏠림 지속 | 쏠림 극단화 → 외부 충격 시 패닉셀 리스크. SI 섹터로 순환매 확산은 긍정적 분산 신호 |
| **★★★ TSMC 지정학 리스크** | 트럼프 미중 협상에서 대만 무기 판매 유보 협상 카드 활용 | TSMC 지정학 불확실성 → 단기 변동성. 장기적으로 삼성·인텔 대안 수혜 가능 |
| **★★★ PCE 3.8% + Fed 금리인상 리스크** | CME FedWatch 12월 금리인상 확률 **~57%** | 이경민: 8~9월 잭슨홀+FOMC에서 조정 가능성. 지금은 풀베팅, 8~9월 대비 필요 |
...
| 항목 | 내용 |
|------|------|
| **전체 방향성** | **삼성 HBM4E 12단 세계 최초 + KOSPI 8,476 ATH + 젠슨황 한국 방문 6/5 + SI섹터 AI재평가 + Computex 6/1 + KOSPI 선행PER 8.16배 저평가** — 반도체를 넘어 AI 인프라 사이클이 산업 전반으로 확산 |
| **최대 카탈리스트 (6/1~)** | **GTC 타이베이 6/1**: Jensen Huang Vera Rubin 발표 + 6/2 Marvell 공동 기조연설 + **6/5 젠슨황 한국 방문**(4대 그룹 총수 회동) + MSCI 6월 발표 + Micron 6/24 어닝콜 |
| **5/30 핵심** | 삼성전자 HBM4E 12단 **세계 최초 출하**(핀속도 +20%, 48GB, SK하이닉스 6~9개월 선도). **KOSPI 8,476 ATH**. SI 섹터 AI재평가(삼성SDS+20%, LG CNS+26%, 현대오토에버+24%). 삼성전기 200만원 돌파(시총 4위). 젠슨황 한국 방문 6/5 확정. 이경민 KOSPI **9,500~10,000** 전망 |
| **5/29 핵심** | Dell AI서버 **$16.1B(+757%)** 블로우아웃. HBM LTA DDR4 **10배** 급등. SK하이닉스 **3년 솔드아웃**. KOSPI **8,397.52**(삼성+SK하이닉스 비중 50% 돌파). 삼성증권 KOSPI **11,000** 상향. Snowflake **+36%** 순환매. TSMC 지정학 리스크 |
| **5/28 핵심** | MU Forward PER **8배**. 역 스케일링 딜레마(HBM 1개=DRAM 4개). Zuckerberg "메모리 비용 상승". SK하이닉스 시총 **$1T**(국내 최초). Marvell 사상최고 어닝 |
| **5/27 핵심** | Micron **$1조 클럽**. SK하이닉스 iHBM. CPU기판 랠리(LG이노텍 +17%). 한국 반도체 수출 **+200%**. SOXX $570.09. KOSPI **8,389(사상 최고)** |
| **추천 종목 (한국 반도체)** | **SK하이닉스**(3년 솔드아웃·LTA PER 15배·노무라 400만원), **삼성전자**(HBM4E 세계 최초·목표 59만원), **삼성전기**(시총 4위·200만원 돌파·FCBGA+실리콘커패시터) |
| **추천 종목 (한국 SI/AX)** | **삼성SDS**(AX 사업·피지컬AI 수혜), **LG CNS**(AX), **현대오토에버**(AX·자동차AI) |
| **추천 기판/소부장** | **LG이노텍**(FCBGA+CPU기판), **심텍**, **대덕전자**, **한미반도체** |
| **추천 종목 (미국)** | **NVDA**(Computex Vera Rubin·Q2 $91B), **MU**(Forward PER 8배·UBS $1,625), **Dell**(AI서버 +757%·$60B 가이던스), **AMD**(ATH·2nm Venice), **Marvell**(AI 연결성) |
| **추천 ETF** | **SOXX($569.08)**, **BOTZ($40.15)**, SCHD |
| **투자 전략** | 삼성 HBM4E 세대 전환 주도권→점유율 확대 기대, SI 섹터 AX 재평가 지속(젠슨황 피지컬AI), 이경민 6~8월 풀베팅+8~9월 조정 대비, 박병창 사이클 50~70% 진행→아직 상승 여력 충분, MSCI 6월 편입 여부 주시 |

**삼성전자 HBM4E 12단 세계 최초 출하**는 HBM3E 열세에서 극적으로 반전하며 차세대 세대 전환에서 6~9개월 선도권을 확보한 것입니다. NVIDIA Vera Rubin Ultra, 마이크론·SK하이닉스보다 앞선 HBM4E 공급 능력은 삼성전자 HBM 점유율 구조적 회복의 신호탄입니다.

**KOSPI 8,476 ATH에서 SI 섹터 AI재평가**는 AI가 하드웨어를 넘어 실제 기업 현장으로 침투하는 새로운 국면을 열었습니다. 젠슨황의 피지컬 AI 비전이 한국 방문(6/5)에서 구체화되면 삼성SDS·LG CNS·현대오토에버 등 AX 사업 기업들의 재평가는 더욱 가속될 수 있습니다.

**이경민(대신증권)의 KOSPI 선행 PER 8.16배 저평가 분석**은 9.5배 적용 시 코스피 9,500, 10배 시 10,000+ 목표를 제시합니다. 6~8월 강세 지속 후 8~9월 잭슨홀+FOMC에서의 조정 가능성을 인식하며 지금은 풀베팅 전략이 유효합니다.
