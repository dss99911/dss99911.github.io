...
redirect_from:
  - /android/2023/12/24/coroutine-retrofit.html
---
...
just load data like below. that’s it (I explained about `BaseViewMode`, `BaseActivity`, `BaseFragment` on [another article]({% link _posts/mobile/android/2023-12-24-reduce-boiler-plate-code.md %}))
