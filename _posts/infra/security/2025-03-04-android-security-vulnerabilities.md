...
핀테크나 금융 관련 앱을 만들다 보면 평소 잘 의식하지 않던 공격 벡터들이 끝없이 튀어나온다. ADB, 앱 변조, 악성 앱, SMS 가로채기, 루팅 등 각 시나리오마다 대응 방법이 다르고, 또 어떤 건 OS 차원에서 막을 수가 없어서 사용자 교육에 의존해야 한다. 그동안 다뤘던 항목들을 한 곳에 정리한다.
