---
layout: post
title: "2026년 반도체 투자 전망: GTCDay2-3·Eaton전력인프라·VeraRubin3nm336B·자율주행40%채택·MicronHBM공급부족·빅테크AI해고·TeraFabD-3·SOXX340.25·NVDA$181.93 (3월 18일 업데이트)"
...
description: "2026년 3월 18일 반도체 섹터 전망. GTC Day 2~3: Eaton 파트너십(AI 데이터센터 전력 인프라), Vera Rubin 상세(TSMC 3nm, 336B 트랜지스터, 추론 H100 대비 25배). 자율주행 연합(글로벌 완성차 40% 엔비디아 드라이브 채택, 2028 28개 도시 로보택시). Micron HBM 공급부족 확인. 빅테크 AI 해고(Meta 20%/15K명, Oracle $2.1B). TeraFab D-3. SOXX 340.25(+0.72%), NVDA $181.93(-0.7%)."
...
**3월 18일 핵심: GTC 2026 Day 2~3가 진행 중입니다.** 키노트 이후 추가 공개된 내용:
- **Eaton 파트너십**: AI 데이터센터 **전력 인프라** 협력 발표 — 전력 병목 해소 의지
- **Vera Rubin 상세**: TSMC **3nm**, **336B 트랜지스터**, AI 추론 H100 대비 **25배** 성능
- **자율주행 연합**: 현대·BYD·닛산·지리 등 **글로벌 완성차 40%** 엔비디아 드라이브 채택, **2028년 28개 도시 로보택시**
- **Micron HBM 공급부족**: 타이트 서플라이 확인, 실적 발표 앞두고 상승
- **빅테크 AI 해고**: Meta **20%(15K명, $135B AI 인프라 투자)**, Oracle **$2.1B** 구조조정 — AI로 인력 재배치, CAPEX 불변
- **TeraFab D-3**: 테슬라 3/21 런칭 임박
...
## 반도체 섹터 현황 (2026년 3월 18일 기준)

### 핵심 지표

| 항목 | 수치/현황 | 비고 |
|------|----------|------|
| **SOXX** | **340.25 (+0.72%)** | GTC 진행 중, 상승 지속 |
| **NVDA** | **$181.93 (-0.7%)** | 키노트 소화 조정 |
...
| 항목 | 내용 |
|------|------|
| **★★★ GTC Day 2~3 진행 중** | **Eaton 파트너십**(AI 데이터센터 전력 인프라 협력), Vera Rubin 상세(TSMC **3nm**, **336B 트랜지스터**, 추론 **H100 대비 25배**) |
| **★★★ 자율주행 연합** | 현대·BYD·닛산·지리 등 **글로벌 완성차 40%** 엔비디아 드라이브 채택, **2028년 28개 도시 로보택시** |
| **★★★ Micron HBM 공급부족** | 타이트 서플라이 확인, 실적 발표 앞두고 상승 |
| **★★ 빅테크 AI 해고** | Meta **20%(15K명)**, $135B AI 인프라 투자 불변. Oracle **$2.1B** 구조조정 — AI 인력 재배치 |
| **★★ HBM4 양산** | SK하이닉스 **70% 점유**, **공급부족** 확인 |
| **★★ TeraFab D-3** | 테슬라 3/21 런칭 **D-3 임박** |
| **★ SOXX/NVDA** | SOXX **340.25(+0.72%)** 상승 지속, NVDA **$181.93(-0.7%)** 키노트 소화 조정 |

---

## GTC 2026 Day 2~3 진행 중 (3/18 업데이트)

GTC 2026이 진행 중입니다. 키노트(3/16)에 이어 Day 2~3에서 추가 파트너십과 기술 상세가 공개되고 있습니다.
...
```mermaid
graph TB
    subgraph GTC2026["GTC 2026 #40;3/16 키노트 + Day 2-3 진행 중#41;"]
        direction TB
        K["Jensen Huang 키노트<br/>#40;3만명 참석#41;"]
        K --> VR["★★★ Vera Rubin<br/>#40;10x 성능/와트, 3nm, 336B 트랜지스터#41;"]
...
## 테슬라 TeraFab (3/21 런칭 D-3 임박)

테슬라가 3월 21일 **TeraFab** 런칭을 예고했으며, **D-3으로 임박**했습니다. 반도체 자체 제조를 통해 엔비디아 칩 의존도를 해소하려는 전략입니다.
...
| **Micron** | **~20%** | Q2 2026 **15K 웨이퍼/월 램프**, **HBM 공급부족 확인** | 2026 전량 매진, 실적 발표 앞두고 상승 |
...
**핵심**: SK하이닉스 70% 점유와 전량 계약 완료, **Micron의 타이트 서플라이 확인**(3/18)까지 — HBM 공급부족이 업계 전반에서 재확인되고 있습니다. 삼성전자의 50% 생산 확대와 세계 최초 양산은 점유율 회복의 전환점이며, 소비자 메모리 부족으로 메모리 업체 전체의 수익성이 극대화되는 구조입니다.
...
### NVIDIA (NVDA) - $181.93 (-0.7%)

| 항목 | 내용 |
|------|------|
| **주가** | **$181.93 (-0.7%)** — 키노트 소화 조정 |
| **GTC Day 2~3 진행 중** | Eaton 파트너십(전력 인프라), Vera Rubin 상세(3nm, 336B, H100 대비 25배), 자율주행 연합(완성차 40% 채택, 2028 28개 도시 로보택시) |
| **GTC 키노트** | Vera Rubin **10x 성능/와트**, Vera Rubin Ultra **144 GPU**, **$1T 구매주문**, Groq 3 LPU, Kyber, 우주 데이터센터 |
| **FY27 매출** | $66B (+68%) |
...
| 전략 | 내용 |
|------|------|
| **단기 (1-2주)** | GTC Day 2~3 진행 중(Eaton, 자율주행 연합, Vera Rubin 상세). **테슬라 TeraFab 런칭(3/21, D-3)** 주시. Micron HBM 공급부족 확인 → 실적 발표 주시. FOMC(3/17-18). S&P 500 리밸런싱(3/23) |
...
1. **GTC Day 2~3 진행 + $1T 구매주문**: Eaton 전력 인프라, 자율주행 연합(완성차 40%), Vera Rubin 상세(3nm, 336B, 25배). $1T 파이프라인 신뢰 강화
2. **Vera Rubin 상세 확정**: TSMC **3nm**, **336B 트랜지스터**, 추론 H100 대비 **25배**. H2 2026 출하. Vera Rubin Ultra 144 GPU + Kyber(2027)
3. **Micron HBM 공급부족 확인**: 타이트 서플라이, 실적 발표 앞두고 상승. SK하이닉스 70% 점유 + 전량 계약 완료
4. **자율주행 TAM 폭발**: 현대·BYD·닛산·지리 등 글로벌 완성차 40% 엔비디아 드라이브 채택, 2028년 28개 도시 로보택시
5. **빅테크 AI 해고 = CAPEX 불변**: Meta 20%(15K명) 해고하되 $135B 투자, Oracle $2.1B 구조조정. 인건비→AI 인프라 재배치
6. **테슬라 TeraFab D-3**: 3/21 런칭 임박. $25B 투자, AI5 칩. 성공 시 반도체 수요 총량 확대
7. **CPO 월가 TOP1 테마**: 구리선 물리적 한계 → 광 전환 불가피, 137% 성장 — Marvell(-30%)/Credo/Corning
8. **~$975B(+25%) 기가사이클**: 메모리 $440B(+30%), AI CAPEX $660-690B 불변
...
|------|------|--------|
| **3/17~18** | **FOMC** | 높음 |
| **3/18~20** | **GTC Day 2~3** — Eaton 전력 인프라, 자율주행 연합, 추가 파트너십 | 높음 |
| **3/20 (예정)** | **Micron 실적 발표** — HBM 공급부족 확인, 가이던스 주시 | **최고** |
| **3/21** | **테슬라 TeraFab 런칭 D-3** ($25B, 2nm, AI5 칩) | **최고** |
...
| 항목 | 내용 |
|------|------|
| **전체 방향성** | **~$975B(+25%)** 기가사이클. GTC Day 2~3 진행 중(Eaton 전력, 자율주행 연합, Vera Rubin 상세). Micron HBM 공급부족 확인. 빅테크 AI 해고 = CAPEX 재배치 |
| **최대 카탈리스트** | **Micron 실적 발표(3/20)**, **TeraFab 런칭(3/21, D-3)**, GTC 추가 파트너십, $1T 구매주문 파이프라인 |
| **3/18 핵심** | GTC Day 2~3: Eaton 전력 인프라, Vera Rubin 상세(3nm, 336B, 25배), 자율주행 연합(완성차 40%, 2028 28개 도시). Micron HBM 공급부족. Meta 20% 해고/$135B 투자 |
| **시장 포지션** | SOXX 340.25(+0.72%), NVDA $181.93(-0.7%), KOSPI 5,683(+3.57%), NASDAQ Tech -1.18% |
| **최대 수혜** | SK하이닉스(PER ~16배, HBM4 70%, 공급부족 확인), 삼성전자(HBM4 양산 + Groq SRAM), NVIDIA($1T + 자율주행 TAM), Micron(HBM 공급부족), Marvell(CPO -30%) |
| **이번 주 주시** | **Micron 실적(3/20)**, **TeraFab(3/21, D-3)**, GTC Day 2~3, FOMC(3/17-18), S&P 500 리밸런싱(3/23) |
| **투자 전략** | **GTC 추가 발표 수혜 확인, Micron 실적→HBM 서플라이 검증, TeraFab D-3 대비, 빅테크 해고=CAPEX 재배치 확인** |

**GTC 2026 Day 2~3가 진행 중입니다.** 키노트 이후 추가 발표: **Eaton 파트너십(AI 데이터센터 전력 인프라)**, **Vera Rubin 상세(TSMC 3nm, 336B 트랜지스터, 추론 H100 대비 25배)**, **자율주행 연합(글로벌 완성차 40% 엔비디아 드라이브 채택, 2028년 28개 도시 로보택시)**. **Micron은 HBM 타이트 서플라이를 확인**했고 실적 발표(3/20)를 앞두고 상승 중입니다. **빅테크 AI 해고(Meta 20%/15K명, Oracle $2.1B)는 인건비를 AI 인프라 투자로 재배치**하는 구조적 전환이며, CAPEX는 불변입니다. **테슬라 TeraFab은 D-3으로 3/21 런칭이 임박**했습니다.
