...
graph LR
    ...
    style D fill:#1877f2,stroke:#333,color:#fff
    style E fill:#00a4ef,stroke:#333,color:#fff
```
...
```mermaid
pie title "클라우드 인프라 시장 점유율 (Q4 2025)"
    "AWS" : 30
    "Azure" : 20
    "GCP" : 13
    "기타" : 37
...
```mermaid
graph TD
    A["Broadcom Custom ASIC 고객"] --> B["Google TPU"]
    A --> C["Meta MTIA"]
    A --> D["ByteDance"]
    A --> E["Apple"]
    A --> F["OpenAI"]
    A --> G["기타 대형 고객"]
    style A fill:#cc0000,stroke:#333,color:#fff
```
...
```mermaid
graph LR
    subgraph "AI SaaS 경쟁 구도"
        A["Palantir AIP\nRule of 40: 114%\n고성장·고밸류"] --> D["엔터프라이즈 AI\n시장"]
        B["ServiceNow Now Assist\n안정적 업셀\n합리적 밸류"] --> D
        C["Salesforce Agentforce\n실행 품질 이슈\nCRM 기반 확장"] --> D
    end
    style A fill:#1a1a2e,stroke:#e94560,color:#fff
    style B fill:#2d6a4f,stroke:#333,color:#fff
    style C fill:#00a1e0,stroke:#333,color:#fff
    style D fill:#f8961e,stroke:#333,color:#fff
```
...
```mermaid
graph TD
    A["AI 에이전트 시장\n$7.84B (2025)"] -->|"CAGR 46.3%"| B["$52.62B (2030)"]
    C["엔터프라이즈 앱 내\nAI 에이전트 탑재율"] --> D["2025: 5% 미만"]
    C --> E["2026: 40%"]
    C --> F["2027: 멀티에이전트\n시스템 33%"]
    style A fill:#1a1a2e,stroke:#e94560,color:#fff
    style B fill:#e94560,stroke:#333,color:#fff
    style E fill:#f8961e,stroke:#333,color:#fff
```
...
```mermaid
quadrantChart
    title "AI SW/클라우드 섹터 투자 매력도"
    x-axis "낮은 성장" --> "높은 성장"
    y-axis "높은 밸류에이션" --> "낮은 밸류에이션"
    quadrant-1 "가치 + 성장"
    quadrant-2 "성장주"
    quadrant-3 "고평가"
    quadrant-4 "가치주"
    "CrowdStrike": [0.7, 0.45]
    "Broadcom": [0.8, 0.5]
    "ServiceNow": [0.6, 0.55]
    "Palo Alto": [0.5, 0.6]
    "Palantir": [0.85, 0.2]
    "Marvell": [0.65, 0.5]
    "Salesforce": [0.35, 0.65]
```
