...
### 세계경제포럼 글로벌 리스크 보고서 핵심

2026년 1월 다보스 포럼(세계경제포럼)의 글로벌 리스크 보고서가 발표되었다. 올해 주제는 **"대화의 정신"**으로, 2025년의 "AI 시대를 위한 협업"에서 한 발 후퇴한 모습이다. 이는 트럼프 시대의 탈세계화, 블록 경제, 지정학적 분열이 심화되면서 협업보다 최소한의 대화라도 유지하자는 메시지로 해석된다.
...
**핵심 변화:**
- 지정학적 대립이 압도적 1위로 부상 (작년 9위에서 급상승)
- AI 관련 리스크는 5등, 8등, 9등으로 하위권 하락
- 3년간 상위권을 차지했던 AI 키워드가 내려가고 지정학이 부상

### 순위 급상승 리스크

1. **지정학적 대립**: 당장 + 향후 2년 모두 최대 위협
2. **경제적 침체/인플레**: 경기 불확실성 증가
3. **자산 버블 붕괴**: 2022년 이후 처음 재등장
4. **위태로운 인프라**: 노후화된 인프라 리스크

### 투자 시사점

다보스 포럼의 예언적 적중률이 높은 점을 고려할 때:

```
2022년: 자산 버블 붕괴 예측 → 적중 (주식 하락)
2023년: 생계비 위기 예측 → 적중 (인플레 지속)
2024년: AI 시대 선언 → 적중 (AI 주도 장세)
2025년: 지정학 갈등 → 적중 (지정학 관련주 강세)
2026년: 지정학 대립 최대 위협
```

**2026년 수익률 상위 섹터 (1월 기준):**
- 10개 상위 섹터 중 8개가 지정학 이슈 관련
- 원전, 우주, 방산, 희토류, 원자재, 은, 에너지 인프라
...
> **핵심 메시지**: 2026년은 지정학 갈등 관련주(방산, 우주, 원전, 희토류, 원자재)를 포트폴리오에 편입하는 것이 확률적으로 유리하다.
