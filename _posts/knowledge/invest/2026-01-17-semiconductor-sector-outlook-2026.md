...
description: "2026년 4월 2일 반도체 섹터 전망. KOSPI 반도체 랠리 — 삼성전자 190,000원(+14%), SK하이닉스 901,500원(+10%), KOSPI 5,500 돌파. SOXX $338.54(+3.01%), BOTZ $33.90(+2.05%). NVIDIA Q4 FY2026 $65B 가이던스, Blackwell 완판, 비GAAP 마진 75%. HBM 2025-2026 전량 매진. TurboQuant 과대평가 확인. 기술 섹터 로테이션(NASDAQ 기술 -2.81% vs 지수 +3.83%)."
...
**4월 2일 핵심:**
- **★★★ KOSPI 반도체 랠리**: 삼성전자 **190,000원(+14%)**, SK하이닉스 **901,500원(+10%)**. TurboQuant 쇼크 + 전쟁 공포에서 회복. **KOSPI 5,500 돌파**
- **★★★ NVIDIA Q4 FY2026 $65B 가이던스**: "Blackwell 판매 off the charts, 클라우드 GPU 완판". 비GAAP 마진 **75%**
- **★★★ TurboQuant 과대평가 확인**: 다수 채널(SOD/염블리/한경TV)이 "과대평가" 확인. 시장은 쇼크에서 완전 회복
- **★★ SOXX/BOTZ 반등**: SOXX **$338.54(+3.01%)**, BOTZ **$33.90(+2.05%)**
- **★★ HBM 전량 매진**: 2025-2026년 HBM 전 용량 고정계약 완판. HBM3E가 2026년 출하의 ~2/3. HBM4 점진 증가. SK하이닉스 HBM4 **Rubin 물량 ~70%**(UBS)
- **★★ Micron 리바운드**: Cantor Fitzgerald **$700 목표가**, top pick 유지. DRAM 현물가 하락은 B2C(매출의 5%)에 국한. AI 데이터센터 수요 견조
- **★ 기술 섹터 로테이션**: NASDAQ 기술 섹터 **-2.81%**(최하위) vs NASDAQ 지수 **+3.83%** → 메가캡 테크에서 경기순환/산업재로 자금 이동

KOSPI 반도체주가 TurboQuant 쇼크와 전쟁 공포에서 **강하게 회복**했습니다. 삼성전자 +14%, SK하이닉스 +10%의 랠리와 함께 KOSPI가 5,500을 돌파했습니다. NVIDIA는 Q4 FY2026 $65B 가이던스로 "Blackwell 판매가 off the charts"라고 밝혔으며, 비GAAP 마진 75%를 유지하고 있습니다.

TurboQuant 메모리 압축 쇼크는 **과대평가로 확인**되었습니다. 다수 유튜브 채널(SOD, 염블리, 한경TV)이 "과대평가"를 확인했으며, 시장은 이미 쇼크에서 완전히 회복했습니다. HBM은 2025-2026년 **전량 고정계약으로 매진** 상태이며, SK하이닉스는 HBM4 Rubin 물량의 ~70%를 확보하고 있습니다. 다만 NASDAQ 기술 섹터가 -2.81%(최하위)를 기록하며 **메가캡 테크에서 경기순환주로의 자금 로테이션**이 관찰되고 있어 주의가 필요합니다.

## 반도체 섹터 현황 (2026년 4월 2일 기준)

### 핵심 지표

| 항목 | 수치/현황 | 비고 |
|------|----------|------|
| **SOXX** | **$338.54 (+3.01%)** | TurboQuant 쇼크 회복 반등 |
| **BOTZ** | **$33.90 (+2.05%)** | AI/로보틱스 동반 반등 |
| **삼성전자 (KOSPI)** | **190,000원 (+14%)** | TurboQuant + 전쟁 공포 회복 랠리 |
| **SK하이닉스 (KOSPI)** | **901,500원 (+10%)** | TurboQuant + 전쟁 공포 회복 랠리 |
| **KOSPI** | **5,500 돌파** | 반도체 랠리 견인 |
| **NVIDIA Q4 FY2026** | **$65B 가이던스** | "Blackwell off the charts", 클라우드 GPU 완판, 마진 75% |
...
| **HBM** | **2025-2026 전량 고정계약 매진** | HBM3E ~2/3 출하, HBM4 점진 증가 |
...
| **Micron** | **Cantor Fitzgerald $700 목표가** | DRAM 현물 하락은 B2C(5%)에 국한, AI DC 수요 견조 |
| **삼성 파운드리** | **NVIDIA 수주 확정, Q3 출하** | 시장 성장이 드라이버 |
| **CPO 시장** | **연간 137% 성장** | 2026년 양산 시작, 월가 TOP1 테마 |
| **공급 부족 전망** | **2027년까지 지속** | IDC/TrendForce |
| **TurboQuant** | **과대평가 확인** | 다수 채널(SOD/염블리/한경TV) 확인, 시장 회복 완료 |
| **기술 섹터 로테이션** | **NASDAQ 기술 -2.81% (최하위)** | NASDAQ +3.83% vs 기술 최하위 → 경기순환주 이동 |
...
| **★★★ KOSPI 반도체 랠리** | 삼성전자 **190,000원(+14%)**, SK하이닉스 **901,500원(+10%)**. TurboQuant 쇼크 + 전쟁 공포에서 회복. **KOSPI 5,500 돌파** |
| **★★★ NVIDIA Q4 FY2026** | **$65B 가이던스**. "Blackwell 판매 off the charts, 클라우드 GPU 완판". 비GAAP 마진 **75%** |
| **★★★ TurboQuant 과대평가 확인** | SOD/염블리/한경TV 등 다수 채널이 "과대평가" 확인. 시장 쇼크에서 **완전 회복** |
| **★★ SOXX/BOTZ 반등** | SOXX **$338.54(+3.01%)**, BOTZ **$33.90(+2.05%)**. 반도체/AI 동반 반등 |
| **★★ HBM 전량 매진** | 2025-2026 HBM 전 용량 **고정계약 매진**. HBM3E ~2/3, HBM4 점진 증가. SK하이닉스 Rubin **~70%**(UBS) |
| **★★ Micron 리바운드** | Cantor Fitzgerald **$700 목표가**, top pick 유지. DRAM 현물 하락은 **B2C(매출 5%)에 국한**, AI DC 수요 견조 |
| **★ 기술 섹터 로테이션** | NASDAQ 기술 **-2.81%**(최하위) vs 지수 **+3.83%** → 메가캡 테크 → 경기순환/산업재 자금 이동 |
...
## TurboQuant: 과대평가 확인 — 시장 회복 완료 (4/2 업데이트)

Google Research가 3월 25일 발표한 **TurboQuant** 논문(KV cache 3비트 압축, 메모리 6x 감소)이 메모리주 급락을 촉발했으나, **과대평가로 확인**되었습니다. 다수 유튜브 채널(SOD, 염블리, 한경TV)이 "과대평가"를 공식 확인했으며, 시장은 쇼크에서 **완전히 회복**했습니다.
...
| **과대평가 확인 (4/2)** | SOD/염블리/한경TV 등 다수 채널이 **"과대평가"** 확인. 시장 **완전 회복** |
| **시장 회복** | 삼성전자 **190,000원(+14%)**, SK하이닉스 **901,500원(+10%)** — 쇼크 전 수준 이상 회복 |

**투자 시사점**: TurboQuant 쇼크는 **과대평가로 결론** 났습니다. (1) 소형 모델(7-8B)만 검증, 프론티어 모델 미적용, (2) 2025년 4월 제출 논문으로 이미 반영 가능성, (3) 제본스 역설에 의해 메모리 수요 오히려 증가 가능. 시장은 삼성전자 +14%, SK하이닉스 +10%로 **완전 회복**하며 TurboQuant 영향은 일시적이었음을 입증했습니다. 향후 유사한 효율성 논문 발표 시 **과매도를 매수 기회**로 활용할 수 있는 선례가 되었습니다.
...
### SK하이닉스 (000660) - 901,500원 (+10%), PER ~16배

| 항목 | 내용 |
|------|------|
| **주가** | **901,500원 (+10%)** (4/2 기준, TurboQuant + 전쟁 공포 회복 랠리) |
...
현재가 ~90.15만원 기준: 목표가 130만원은 **+44%**, 145만원은 **+61%**.

### 삼성전자 (005930) - 190,000원 (+14%)

| 항목 | 내용 |
|------|------|
| **주가** | **190,000원 (+14%)** (4/2 기준, TurboQuant + 전쟁 공포 회복 랠리) |
...
| **SOXX** | **$338.54 (+3.01%)** | TurboQuant 쇼크 회복 반등 |
| **BOTZ** | **$33.90 (+2.05%)** | AI/로보틱스 동반 반등 |
| **삼성전자 (KOSPI)** | **190,000원 (+14%)** | 회복 랠리 |
| **SK하이닉스 (KOSPI)** | **901,500원 (+10%)** | 회복 랠리 |
| **KOSPI** | **5,500 돌파** | 반도체 견인 |
| **NVIDIA Q4 FY2026** | **$65B 가이던스** | Blackwell 완판, 마진 75% |
| **Micron** | **Cantor $700 목표가** | DRAM 현물 하락 = B2C(5%)에 국한 |
| **글로벌 반도체 2026** | **~$975B (+25% YoY)** | WSTS. **$1T 돌파 근접**, 메모리 +30% |
| **HBM 시장 2026** | **$54.6B (+58% YoY)** | BofA 추정 |
| **기술 섹터 로테이션** | **NASDAQ 기술 -2.81%** | NASDAQ +3.83% vs 기술 최하위 |
...
| 리스크 | 현황 | 평가 |
|--------|------|------|
| **★★ 기술 섹터 로테이션** | NASDAQ 기술 -2.81%(최하위) vs 지수 +3.83% | **메가캡 테크 → 경기순환/산업재 자금 이동. 로테이션 지속 시 반도체 수급 압박 가능** |
| **★★ SK하이닉스 ADR 희석** | 10~15조원(시총 2.4%) | 희석 제한적, PER 16→MU급 34로 리레이팅 시 효과 압도 |
| **★★ FOMC 긴축 기조** | 금리인상 확률 상승, 성장주 압박 | SOXX 반등했으나 금리 리스크 상존 |
| **★ TurboQuant (해소)** | 과대평가 확인, 시장 완전 회복 | **리스크 해소**. 삼성 +14%, SK +10% 회복 완료. 향후 유사 쇼크 시 매수 기회 |
