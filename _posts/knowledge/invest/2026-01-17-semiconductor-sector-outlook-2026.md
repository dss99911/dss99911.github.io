...
description: "2026년 5월 22일 반도체 섹터 전망. NVDA Q1 FY27 매출 $81.6B(+85% YoY), 데이터센터 $75.2B(+92%) 역대 최고, Q2 가이던스 $91B(컨센서스 대폭 상회), 베라루빈 3Q 출하 확정. 삼성전자 노사합의(+8.5%, 29.9만원), SK하이닉스 +11%(14만원), 삼성전기 실리콘 캐패시터 1.6조 계약. 하이퍼스케일러 CapEx $745B. SOXX $524.71."
...
**5월 22일 핵심:**
- **★★★ NVDA Q1 FY27 초대형 어닝**: 매출 **$81.6B**(+85% YoY, 컨센서스 $79.2B 상회), 데이터센터 **$75.2B**(+92%) 단일 분기 역대 최고, EPS $1.87(예상 $1.78 상회). Q2 가이던스 **$91B**(컨센서스 $86.8B 대폭 상회). 배당 **+2,400%**($0.01→$0.25), 자사주매입 $80B 신규 인가
...
- **★★ TaaS(토큰 기반 과금) 전환**: SaaS→토큰 결제 전환. 구글 분당 API 토큰 처리량 160억→**190억**(1개월 만). 토큰 처리량 = 빅테크 매출 선행지표

**5월 20일 핵심 (참고):**
- **★★★ 마이크론 Q2 실적 대호황**: 매출 $28.86B(+196% YoY), OP $16.135B(+810% YoY). 목표주가 $700→$1,100 상향(Melvius)
- **★★★ 엔비디아 베라 CPU 초기 공급 시작**: SpaceX, OpenAI, Anthropic, Oracle Cloud에 초기 베라 실리콘 직접 전달

## 반도체 섹터 현황 (2026년 5월 22일 기준)
...
| **NVIDIA** | **어닝 후 소폭 하락** | 탈엔비디아 우려 복합. Q1 매출 $81.6B(+85% YoY) |
| **인텔** | **CPU 르네상스 지속** | 주간 강세 유지 |
| **SK하이닉스** | **+11% (14만원)** | HBM 2026 capacity 전량 매진. HBM4 점유율 70%(UBS) |
...
| **HBM 공급 부족** | **2027~2030년까지 지속** | Samsung·SK Group 공식 발표. DRAM 가격 2Q 상승률 당초 40% 예상 크게 상향 |
...
| **H/A 클라우드 임대 가격** | **연초 대비 +15~20% 상승** | AI 인프라 수요 폭발 반영 |
...
## NVDA Q1 FY27 초대형 어닝 — 단일 분기 역대 최고 (5/22 업데이트)
...
| **H/A 클라우드 임대 가격** | 연초 대비 **+15~20% 상승** |

**투자 시사점**: NVDA Q2 가이던스 $91B은 AI 인프라 수요가 여전히 가속 중임을 증명합니다. 베라루빈 3Q 출하 확정은 HBM4 수요를 구조적으로 당기고, 이는 삼성전자·SK하이닉스 실적에 직접 반영됩니다. $80B 자사주매입 신규 인가는 NVDA의 자본 배분 여력을 보여줍니다.
...
**투자 시사점**: Samsung과 SK Group 양사가 동시에 2027~2030 쇼티지를 공식화한 것은 HBM 가격 결정력의 장기 유지를 의미합니다. NVDA 베라루빈 3Q 출하 확정으로 HBM4 수요가 당겨지며 DRAM 가격 2Q 상승률도 당초 40% 예상을 상향 조정 중입니다.
...
### NVIDIA (NVDA) — Q1 FY27 $81.6B, Q2 가이던스 $91B
...
| **자사주매입** | **$80B** 신규 인가 |
| **배당** | $0.01→**$0.25** (+2,400%) |
| **목표가** | Goldman $250, Morgan Stanley $260, BofA 상향 |
...
1. **NVDA Q1 FY27 초대형 어닝(5/22)**: 매출 $81.6B(+85%), 데이터센터 $75.2B(+92%) 역대 최고. Q2 가이던스 $91B(컨센서스 대폭 상회). 베라루빈 3Q 출하 확정
2. **삼성전자 노사합의(5/22)**: DS 200조 영업이익 보장. 연간 1.2억주 자사주 매입 → 주가 구조적 지지. 반도체 수출 4~5월 31조(1Q 15조 대비 2배+)
3. **SK하이닉스 +11%(5/22)**: HBM 2026 capacity 매진 지속. NVDA 베라루빈으로 HBM4 수요 당김. 목표가 SK증권 300만원
4. **삼성전기 실리콘 캐패시터 1.6조(5/22)**: 마벨향 계약 확인. AI 반도체 부품 공급망 핵심 위치
5. **TaaS 전환 가속(5/22)**: 구글 분당 토큰 처리량 190억(1개월 만). 토큰 처리량 = 빅테크 매출 선행지표
6. **하이퍼스케일러 CapEx $745B**: 구글 클라우드 +63% YoY(역대 최고). 투자 피크아웃 신호 없음
7. **빅테크 Q1 AI 구조적 수요 확인(5/5)**: AWS +28%(15분기 최고), 구글 클라우드 +63%(역대 최고·EPS 5.11 예상치 2배). "컴퓨팅 용량 부족" 일제 언급
8. **HBM 공급 부족 2027~2030 공식화(5/5)**: Samsung+SK Group 동시 확인. HBM3E 가격 20% 인상
9. **2027년 쇼티지 공식화(삼성전자 발언)**: 데이터센터 투자→가동 2년 소요 → 2027H2~2028 수요 집중. SK Group "2030년까지 쇼티지"와 일치
10. **CPU 르네상스**: AI 추론 전환 → GPU:CPU 비율 8:1→1:8 전망. INTC 지속 강세. 에버코어 $111 목표
11. **SK하이닉스 2026 capacity 매진**: HBM4 70% 점유율. HBM3E 가격 20% 인상. 연간 ~290조원 시나리오
12. **메모리 슈퍼사이클**: BofA DRAM +51%, NAND +45% YoY. Micron Q2 +196% 실적 확인
13. **광통신 N² 수요**: GPU 클러스터 N배 → 연결 N² 배. Lumentum/Coherent/Credo 구조적 수혜
14. **삼성전자 파운드리 반전**: 2nm "조만간 수주" + TSMC 캐파 부족 수혜. "Samsung is back". 노사합의로 생산 리스크 해소
...
8. **NVDA 탈엔비디아 가속** — 빅테크 자체칩 비중이 예상보다 빠르게 증가 시
...
| 리스크 | 현황 | 평가 |
|--------|------|------|
| **★★ 탈엔비디아 우려** | NVDA 어닝 후 소폭 하락 | 빅테크 자체칩 비중 증가 우려. 그러나 전체 AI 인프라 수요는 확대 — 단기 조정은 매수 기회 |
...
| 항목 | 내용 |
|------|------|
| **전체 방향성** | **NVDA Q1 FY27 $81.6B(+85%) 초대형 어닝 + 베라루빈 3Q 출하 확정 + 삼성전자 노사합의 + CapEx $745B** — 반도체 슈퍼사이클 2026~2030 구조적 확장 국면 |
| **최대 카탈리스트** | NVDA 데이터센터 $75.2B(+92%) 단일 분기 역대 최고. 베라루빈 3Q 출하 확정 → HBM4 수요 당김. 삼성전자 노사합의 → 구조적 자사주 매입 + 노조 리스크 해소. 구글 분당 토큰 190억(TaaS 전환 가속) |
| **5/22 핵심** | SOXX **$524.71(+0.85%)**. 삼성전자 **+8.5%(29.9만원)**. SK하이닉스 **+11%(14만원)**. 삼성전기 **+13%(120만원)**. ARM **+16%**. NVDA Q2 가이던스 **$91B** |
| **추천 종목 (한국)** | **삼성전자**(노사합의·자사주매입·목표가 59만원), **SK하이닉스**(HBM 70%·마진 72%·2030 쇼티지 수혜), **삼성전기**(실리콘 캐패시터 1.6조·목표가 160만원) |
| **추천 종목 (미국)** | **NVDA**(Q1 $81.6B·Q2 $91B 가이던스·베라루빈 3Q), **AVGO**(자체칩 외부판매 수혜), **INTC**(CPU 르네상스), **GOOGL**(클라우드 +63%·TaaS), **AMZN**(AWS +28%), **ARM**(+16%) |
| **추천 소부장** | **심택**(+20%), **한미반도체**(+15%) |
| **추천 ETF** | **SOXX** |
| **투자 전략** | HBM 2027~2030 쇼티지(SK하이닉스·Micron), 베라루빈 HBM4 수요(삼성·SK하이닉스), 삼성전기 실리콘 캐패시터, 자체 반도체 외부판매 수혜(Broadcom), CPU 르네상스(Intel·AMD), 광통신 N² 수요(Lumentum·Coherent·Credo) |

NVDA Q1 FY27 데이터센터 매출 $75.2B(+92%)는 AI 인프라 수요가 여전히 가속 중임을 증명합니다. 베라루빈 3Q 출하 확정으로 HBM4 수요가 당겨지며, 삼성전자·SK하이닉스 양사 모두 직접 수혜를 받습니다. 삼성전자 노사합의는 연간 1.2억주 자사주 매입을 통한 구조적 주가 지지와 함께 DS 200조 영업이익 보장으로 실적 가시성을 높였습니다.

TaaS(토큰 기반 과금) 전환이 가속되면서 구글 분당 API 토큰 처리량이 1개월 만에 160억→190억으로 급등하였고, 이는 AI 인프라 수요의 폭발적 성장을 선행 시사합니다. 하이퍼스케일러 CapEx $745B는 AI 투자 피크아웃 우려를 불식시킵니다.
