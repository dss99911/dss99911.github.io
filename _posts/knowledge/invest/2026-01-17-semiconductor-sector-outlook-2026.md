...
description: "2026년 5월 26일 반도체 섹터 전망. AMD 데이터센터 매출 $5.8B로 Intel $5.1B 추월(Q1 2026). CPU:GPU 비율 1:8→1:4로 급변, 향후 1:1 수렴 전망(Counterpoint). AMD 2nm Venice EPYC Zen6 TSMC N2 양산. NVIDIA Vera CPU 단독 판매 올해 $20B 목표. 6/2 컴퓨텍스(NVDA·AMD·Intel CEO 총출동). AMD 대만 $10B AI 투자. ARM 주간 +46.5% 급등 신고가. SOXX $537.33(+2.41%). KOSPI 사상 최고 8,060."
...
## 반도체 섹터 현황 (2026년 5월 26일 기준)

### 핵심 지표

| 항목 | 수치/현황 | 비고 |
|------|----------|------|
| **SOXX** | **$537.33 (+2.41%, 5/26)** | 반도체 섹터 강세 지속 |
| **BOTZ** | **$40.29 (+1.61%, 5/26)** | AI 로봇·자동화 ETF |
| **KOSPI** | **8,060.86 (사상 최고, 5/26)** | 역대 최고가 돌파 |
| **NVIDIA** | **~$215. BofA Vivek Arya 목표가 $350** | Vera CPU 단독 판매 $20B 목표. 중국 시장 화웨이에 "largely conceded" |
...
| **인텔** | **CPU 르네상스 수혜 지속** | Q1 데이터센터 $5.1B. AMD에 추월당하나 절대 성장 지속 |
| **SK하이닉스** | **ATH 194.9만원 (YTD +197%)** | HBM 공급 부족 2028년까지. MS/Google/Amazon 선투자 |
| **삼성전자** | **29.9만원대. 목표가 노무라 59만원, JPMorgan 48만원** | 노사합의. HBM4 6월 공급. 삼성/SK하이닉스 레버리지 ETF 5/28 출시 |
| **삼성전기** | **120만원대** | 마벨향 실리콘 캐패시터 1.6조 계약. 목표가 160~170만원 |
| **Micron** | **Q2 매출 $28.86B (+196% YoY), OP $16.135B (+810% YoY). 목표주가 $700→$1,100 상향 (Melvius)** | 메모리 슈퍼사이클 구조적 수요 확인 |
| **루멘텀(Lumentum)** | **CPO 독점 — 향후 1년 매출 2배 성장 전망** | 3Q 변곡점: HBM 가격→수량 모멘텀 전환 |
...
| 종목 | 현황 | 투자 포인트 |
|------|------|-----------|
| **삼성전자** | 29.9만원대. 노사합의. PER 6.5배 저평가 | 노사합의로 노조 리스크 해소. 자사주 1.2억주 매입 → 주가 구조적 지지. DS 200조 영업이익 보장. 레버리지 ETF 5/28 출시. 목표가 노무라 59만원 |
| **SK하이닉스** | ATH 194.9만원(YTD +197%). HBM 2026 전량 매진 | HBM 70% 점유(UBS). 2027~2030 쇼티지 구조적 수혜. NVDA 베라루빈 3Q 출하로 HBM4 수요 당김. 레버리지 ETF 5/28 출시. 목표가 MS 170만원, SK증권 300만원 |
| **삼성전기** | 120만원대 | 마벨향 실리콘 캐패시터 1.6조 계약. AI 반도체 핵심 부품 공급망 내 위치 확인. 목표가 160~170만원 |
...
| 항목 | 수치 | 비고 |
|------|------|------|
| **SOXX** | **$537.33 (+2.41%, 5/26)** | 반도체 섹터. 5/22 $524.71 대비 추가 상승 |
| **BOTZ** | **$40.29 (+1.61%, 5/26)** | AI 로봇·자동화 ETF |
| **KOSPI** | **8,060.86 (사상 최고, 5/26)** | 역대 최고가 |
...
| **SK하이닉스** | **ATH 194.9만원 (YTD +197%)** | HBM 2026 capacity 매진. 목표가 SK증권 300만원 |
| **삼성전자** | **29.9만원대 (5/21 +8.5%)** | 노사합의. 목표가 노무라 59만원. 레버리지 ETF 5/28 출시 |
| **삼성전기** | **120만원대** | 마벨향 실리콘 캐패시터 1.6조 |
...
| **TSMC 2Q 가이던스** | **$39-40.2B** | AMD 2nm Venice N2 양산 추가 수혜 |
...
1. **AMD 데이터센터 매출 Intel 추월(5/26)**: AMD $5.8B vs Intel $5.1B (Q1 2026). CPU 시장 패권 이동 역사적 확인. AMD 2nm Venice(EPYC Zen6) TSMC N2 양산, 납기 8~10주 연장으로 수요 급증 확인
2. **CPU:GPU 비율 급변(5/26, Counterpoint Research)**: 1:8 → 1:4 (이미 변화), 향후 1:1 수렴 전망. GPU 중심 투자 패러다임 구조 전환 진행 중
