---
layout: post
title: "2026년 DRAM/NAND 투자 전망: DRAM 리드타임 40주+·메모리 공급부족 2028년까지·DRAM Q1 +90-95%·NAND +55-60%·호르무즈 봉쇄 변동성 (3월 2일 업데이트)"
date: 2026-03-02 09:00:00 +0900
categories: [knowledge, invest]
tags: [투자, DRAM, NAND, 삼성전자, SK하이닉스, 마이크론, 메모리, 반도체, 2026전망, 슈퍼사이클, HBM4, HBF, 관세, 기가사이클, Section122, LPDDR, ClientSSD, 호르무즈봉쇄, 리드타임]
description: "DRAM 리드타임 40주 이상으로 2026 계획 수립 어려움. 메모리 구조적 공급 부족 2028년까지 지속(마이크론). DRAM Q1 +90-95% QoQ 확정, NAND Q1 +55-60%. 이란 호르무즈 봉쇄로 유가 급등(Brent $79.15 +8.6%), 시장 변동성 확대. Section 122 15% 발효 중."
---
...
**첫째**, **DRAM 리드타임이 40주 이상**으로 연장되어 **2026년 계획 수립 자체가 어려운 상황**입니다. 마이크론은 메모리 **구조적 공급 부족이 2028년까지 지속**될 것으로 전망합니다.

**둘째**, DRAM Q1 가격 **+90~95% QoQ 상승이 확정**되었으며, **LPDDR4X/LPDDR5X도 +90%** 동반 상승합니다. 역대 최대폭 상승이 실현되었습니다.

**셋째**, NAND Q1 **+55~60%**, Client SSD **+40% 이상** 상승이 확인되었습니다.

**넷째**, 이란 **호르무즈 해협 봉쇄 실행**으로 유가 급등(Brent $79.15 +8.6%), 에너지 비용 상승이 반도체 생산 비용에도 영향을 미칠 수 있습니다.
...
**DRAM 리드타임이 40주 이상**으로 연장되면서, 고객사들은 2026년 조달 계획 수립 자체가 어려운 상황입니다. 마이크론은 메모리 구조적 공급 부족이 **2028년 이후까지 지속**될 것으로 전망하고 있어, DRAM 가격 상승 사이클이 장기화될 가능성이 높습니다.
