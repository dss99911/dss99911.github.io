---
layout: post
title: "2026년 투자 섹터 전망: FOMC동결3.5%·매파PPI+0.7%·S&P6624(-1.36%)·Brent$110이란가스전공습·WTI$98·Samsung-AMD-HBM4MoU·Micron실적·KOSPI5777(+2.42%)·금$5030·GTC마감·BTC$71K (3월 19일 업데이트)"
...
description: "2026년 3월 19일 기준. FOMC 동결(3.5-3.75%) 11:1. PPI +0.7%(예상 2배). S&P 6,624(-1.36%) 4개월래 최저. 이스라엘 이란 가스전 공습 Brent ~$110, WTI ~$98. Brent-WTI 스프레드 $10. Samsung-AMD HBM4 MoU. Micron EPS $8.42, HBM 매진. KOSPI 5,777(+2.42%). 금 ~$5,030. BTC $71K(-3.84%). GTC 마감."
last_modified_at: 2026-03-19
---

**3월 19일, FOMC 매파 동결 + 이란 가스전 공습 Brent $110 + S&P 6,624(-1.36%).** FOMC **11:1 동결(3.5-3.75%)**. PPI **+0.7%**(예상 +0.3%의 2배 이상), Core PPI YoY **3.9%** 1년래 최고. 점도표 **1회 인하만**(20bp). S&P 500 **6,624(-1.36%)** 4개월래 최저, Dow **-750pt**. 이스라엘, **이란 최대 가스전(South Pars) 공습** → Brent **~$110(+5%)**, WTI **~$98(+2.5%)**. **Brent-WTI 스프레드 $10**(정상 $2-5). 이란 안보수장 **Larijani 피살**.

**Samsung-AMD HBM4 MoU + Micron 실적.** Samsung-AMD **HBM4 MoU** 체결 — MI455X용 HBM4 공급 + 파운드리 협력 논의. Samsung **1c DRAM + 4nm 로직** 기반 HBM4, **3.3TB/s** 대역폭. Micron **EPS $8.42 전망**, HBM **2026년 말까지 매진**. 반도체 시장 **$1조** 돌파 임박.

**KOSPI 5,777(+2.42%) + BTC $71K.** KOSPI **5,777(+2.42%)** 급등 — 삼성 +2.83%, SK하이닉스 +7.03%. EWY 1W **+6.79%**, 3M **+47.32% 글로벌 최강** 유지. **BTC $71,082(-3.84%)** 하락. 금 **~$5,030** $5K 위 유지. Goldman 금 **$6,000** 장기 타겟.

**에너지 위기 심화 + 방산 강세 지속.** Goldman **유가 전망 상향**. 이란, 사우디·UAE·카타르 석유시설 위협. Rheinmetall **45% 매출 성장** 가이던스, 수주잔고 **€63.8B 사상 최대**. EU ReArm **€800B**. 테슬라 로보택시 — LG에너지솔루션 **$4.3B LFP** 계약, 라스베이거스 확장 준비, 마일당 $1.4(마진율 78%).

**사모신용 위기 지속 + FOMC 매파 → 리파이낸싱 부담.** $2.1T 시장 2008년 이후 최대 위기 지속. 에이전틱 AI가 SaaS 담보 파괴 + 일자리 파괴 → 사모신용 부도율 **9.2% 사상 최고**. FOMC 매파 스탠스로 **금리 인하 지연** → 사모신용 리파이낸싱 부담 가중. 하이일드 스프레드 **3.22%**.
...
| 지수 | 수준 | 변동 | 비고 |
|------|------|----------|------|
| **S&P 500 (SPY)** | **6,624** | **-1.36%** | **★★ FOMC 매파 동결+PPI핫→4개월래 최저. Dow -750pt** |
| **NASDAQ** | **~22,150** | **-1.46%** | **★ FOMC 후 기술주 하락** |
| **Dow** | **~46,240** | **-750pt** | **★ 대폭 하락** |
| **KOSPI** | **5,777** | **+2.42%** | **★★ 급등. 삼성 +2.83%, SK하이닉스 +7.03%** |
| **상해종합** | **4,063** | **+0.32%** | 소폭 상승 |
| **항셍** | **26,025** | **+0.61%** | 소폭 상승 |
| **원/달러** | **~1,499원** | **+0.47%** | **1,500원 심리선 근접. WGBI 4월 편입** |
| **Brent** | **~$110** | **+5%** | **★★★ 이란 가스전(South Pars) 공습. 사상 최고 수준** |
| **WTI** | **~$98** | **+2.5%** | **★★ Brent-WTI 스프레드 $10(정상 $2-5)** |
| **금(Gold)** | **~$5,030/oz** | **+0.3%** | **$5K 위 유지. 이란 안보수장 피살→안전자산** |
| **은(Silver)** | 강세 유지 | **$100 전망 지속** | 6년 연속 공급적자 |
| **비트코인** | **$71,082** | **-3.84%** | **★ 하락. 위험자산 기피** |
| **VIX** | **22.37→상승 추정** | **S&P -1.36%** | **FOMC 후 반등 예상. PPI핫+유가$110** |
| **TLT** | **86.96** | **-0.57%** | 10Y 4.20%, 2Y 3.68%, 스프레드 0.50% |
| **SOXX** | **338.29** | **-0.58%** | **FOMC 여파. Samsung-AMD HBM4 MoU 긍정** |
| **하이일드 스프레드** | **3.22%** | **-1.53%** | **소폭 축소이나 사모신용 리스크 지속** |
| **5Y Breakeven** | **2.66%** | **+1.53%** | **★ 인플레 기대 상승(PPI핫+유가$110)** |
| **실업률** | **4.4%** | **+0.1%p** | **FOMC 동결 확정. 12월 1회 인하만** |

### 이번 주 핵심 변화 (3/19 업데이트)

| 항목 | 변화 | 투자 시사점 |
|------|------|-----------|
| **★★★ FOMC 매파 동결** | **11:1 동결(3.5-3.75%). PPI +0.7%(예상 2배). Core PPI 3.9% 1년래 최고. 점도표 1회 인하만(20bp). 다음 인하 12월 이후** | **인플레 우려 강화. 금리인하 기대 소멸** |
| **★★★ 이란 가스전 공습** | **이스라엘, 이란 최대 가스전(South Pars) 공습. Brent ~$110(+5%). WTI ~$98. Brent-WTI 스프레드 $10(정상 $2-5). Larijani 피살** | **유가 $100+ 고착화. 인플레 재점화** |
| **★★★ S&P 6,624(-1.36%)** | **4개월래 최저. Dow -750pt. FOMC+PPI핫+유가$110 삼중 악재. 200일선(6,589) 근접** | **바닥 형성 약화. 추가 하락 리스크** |
| **★★ Samsung-AMD HBM4 MoU** | **Samsung, AMD MI455X용 HBM4 공급 MoU. 1c DRAM+4nm 로직, 3.3TB/s. 파운드리 협력도 논의** | **삼성 HBM 점유율 확대. AMD 경쟁력 강화** |
| **★★ Micron 실적** | **EPS $8.42 전망. HBM 2026년 말까지 매진. AI 메모리 슈퍼사이클** | **메모리 반도체 최강 섹터** |
| **★★ KOSPI 5,777(+2.42%)** | **삼성 +2.83%, SK하이닉스 +7.03%. EWY 1W +6.79%, 3M +47.32% 글로벌 최강** | **한국 시장 미국과 디커플링** |
| **★★ GTC 마감(Day 3/최종)** | **Healthcare AI(Open-H, GR00T-H). 파트너 어워드. 오픈 프론티어 모델 패널** | **GTC 촉매 소화 완료. TeraFab 3/21로 이동** |
| **★ Goldman 유가 전망 상향** | **이란 전쟁 에스컬레이션 반영. 봉쇄 장기화→$130+ 시나리오** | **에너지 섹터 비중 상향 검토** |
| **★ 테슬라 로보택시** | **LG에너지솔루션 $4.3B LFP 계약. 라스베이거스 확장(세척 노즐 장착 Model Y). 마일당 $1.4(마진 78%)** | **로보택시 수익성 검증** |
| **★ 금 ~$5,030** | **$5K 위 유지. Larijani 피살→안전자산. Goldman $6,000 장기 타겟** | **안전자산 수요 구조적** |

### 핵심 매크로 변수 5가지

#### 1. 이란 가스전 공습 → Brent $110 + 유가 위기 심화

| 항목 | 내용 | 투자 시사점 |
|------|------|-----------|
| **★★★ 이란 가스전 공습** | **이스라엘, 이란 최대 가스전(South Pars) 공습. Brent ~$110(+5%), WTI ~$98** | **유가 $100+ 고착화. 에너지 위기 심화** |
| **★★ Brent-WTI 스프레드 $10** | **정상 $2-5 대비 $10. 해상 공급 스트레스 사상 최대** | **글로벌 원유 공급 교란 심각** |
| **★★ Larijani 피살** | **이란 안보수장 이스라엘 공습으로 사망. 이란 보복 맹세** | **에스컬레이션 리스크 최고조** |
| **★ 이란 석유시설 위협** | **이란, 사우디·UAE·카타르 석유시설 위협** | **걸프 전체 에너지 인프라 위험** |
| **★ Goldman 유가 상향** | **이란 전쟁 에스컬레이션 반영 유가 전망 상향** | **유가 장기 고공 행진 확정** |
| **NATO 균열 지속** | **프랑스·그리스·노르웨이 이란전 협조 거부 지속** | **서방 연합 약화→장기전** |
| **한국 비축유** | **석유 비축량 7개월치 보유** | 단기 위기 가능성 낮음 |

**핵심 판단:** 이스라엘이 **이란 최대 가스전(South Pars)을 미국과 합동 공습** — 세계 최대 천연가스 매장지 타격은 **전쟁의 새로운 국면**. Brent **~$110(+5%)**, WTI **~$98**. **Brent-WTI 스프레드 $10**(정상 $2-5)로 해상 공급 스트레스 사상 최대. 이란 안보수장 Larijani 피살로 **이란 보복 예상**. 유가 **$100+ 고착화** 확정적. **에너지 비중 14%→15% 상향** 검토(유가 상방 리스크 증가).
...
#### 3. KOSPI 5,777(+2.42%) + EWY 1W +6.79% 글로벌 최강

| 항목 | 내용 | 투자 시사점 |
|------|------|-----------|
| **★★ KOSPI 3/19** | **5,777 (+2.42%)** | **급등. 삼성 +2.83%, SK하이닉스 +7.03%** |
| **★★ EWY 1W +6.79%** | **주간 글로벌 최강 수익률** | **한국 시장 미국과 디커플링** |
| **★ EWY 3M +47.32%** | **3개월 글로벌 최강 지속** | **한국 구조적 상승** |
...
**판단:** KOSPI **5,777(+2.42%)** 급등 — **삼성전자 +2.83%, SK하이닉스 +7.03%** 반도체 주도 상승. Samsung-AMD HBM4 MoU가 **삼성 반도체 신뢰도 회복** 촉매. EWY 1W **+6.79%로 주간 글로벌 최강**(대만 EWT +2.26%, 미국 SPY -0.70%). 미국 S&P -1.36% 하락에도 KOSPI 급등 — **미-한 디커플링** 현상. WGBI 4월 편입($56B+)이 구조적 원화 강세 촉매. **한국 시장 구조적 상승 지속**.

#### 4. GTC 마감 + Samsung-AMD HBM4 MoU + Micron 실적 + TeraFab D-2

| 항목 | 내용 | 투자 시사점 |
|------|------|-----------|
| **★★ Samsung-AMD HBM4 MoU** | **MI455X용 HBM4 공급. 1c DRAM+4nm 로직, 3.3TB/s. 파운드리 협력도 논의** | **삼성 HBM 점유율 확대. AMD 경쟁력 강화** |
| **★★ Micron EPS $8.42** | **Q2 실적 발표. HBM 2026년 말까지 매진. "AI-fueled supercycle"** | **메모리 슈퍼사이클 최종 확인** |
| **★★ GTC 마감(3/19)** | **최종일: Healthcare AI(Open-H, GR00T-H), 파트너 어워드, 오픈 프론티어 모델 패널** | **GTC 촉매 소화 완료** |
| **★ Vera Rubin 10x** | **TSMC 3nm, 336B 트랜지스터. AI 추론 25배(H100 대비)** | **AI 효율성 혁명** |
| **★★ TeraFab D-2** | **3/21 런칭. $25B, 2nm, 월 100만 웨이퍼. AI5 칩** | **NVDA/TSMC 경쟁 구도 변화 잠재** |
| **HBM4 양산** | **SK하이닉스 70%(UBS). 삼성 AMD MoU로 점유율 확대** | **메모리 슈퍼사이클** |
| **반도체 $1T** | **SIA 2026년 $1조 돌파 전망. 메모리 핵심 동력** | **기가사이클 가속** |
| **SOXX 338.29** | **-0.58% FOMC 여파. NVDA $180.40(-0.84%)** | **단기 조정, 펀더멘탈 견조** |

**핵심 판단:** GTC 3일간 마감 — **$1T 주문, Vera Rubin, Healthcare AI** 등 주요 발표 소화 완료. **Samsung-AMD HBM4 MoU**로 삼성 반도체 신뢰도 회복 + AMD의 NVIDIA 대항마 포지션 강화. **Micron EPS $8.42, HBM 매진** — 메모리 슈퍼사이클 최종 확인. FOMC 매파 동결로 **SOXX -0.58%** 소폭 조정이나 펀더멘탈은 견조. 테슬라 **TeraFab D-2(3/21 런칭)**. **반도체 비중 20% 유지**.

#### 5. FOMC 매파 동결 + PPI 핫 + S&P 6,624(-1.36%) 하락

| 항목 | 현황 | 변화 |
|------|------|------|
| **★★★ FOMC 매파 동결** | **11:1 동결(3.5-3.75%). PPI +0.7%(예상 2배)** | **매파적. 인플레 우려 강조** |
| **★★★ 점도표 1회 인하** | **2026년 1회 인하(20bp)만 전망. 다음 인하 12월 이후** | **금리인하 기대 사실상 소멸** |
| **★★ S&P 6,624(-1.36%)** | **4개월래 최저. Dow -750pt** | **FOMC+PPI+유가 삼중 악재** |
| **★★ S&P 200일선 근접** | **6,624, 200일선(6,589) 근접(35pt 차이)** | **이탈 시 추가 하락 리스크** |
| **★ Core PPI 3.9%** | **YoY 1년래 최고. 도매 인플레 가속** | **CPI에도 영향→Fed 긴축 장기화** |
| 원/달러 환율 | **~1,499원** | **1,500원 근접. WGBI 4월 편입** |
| DXY | **120.55** (Broad) | **달러 강세(금리 장기화 반영)** |
| **실업률** | **4.4% (+0.1%p)** | **NFP -92K, 노동시장 약화 vs 인플레→스태그** |
| **5Y Breakeven** | **2.66% (+1.53%)** | **★ 인플레 기대 더 상승(PPI핫+유가$110)** |
| **10Y 금리** | **4.20%** | **장단기 스프레드 0.50%** |
| **RRP** | **$0.70B** | 역레포 거의 고갈 |
| WGBI 편입 | **4월 시작, 8회 분할 편입** | $56B+ 유입 전망 |

**판단:** FOMC **매파 동결** — PPI **+0.7%**(예상 +0.3%의 2배 이상)로 인플레 우려 강화. 점도표 **1회 인하만**(20bp), 다음 인하 **12월 이후**. S&P 500 **6,624(-1.36%)** 4개월래 최저, **200일선(6,589)에 35pt까지 근접** — **이탈 시 추가 하락** 리스크. 이란 가스전 공습(Brent $110) + 핫 PPI + 매파 FOMC **삼중 악재**로 **바닥 형성 시나리오 약화**. **현금 16% 유지**, FOMC 이후 추가 인하 기대 소멸로 **축소 보류**. 그러나 KOSPI **5,777(+2.42%)**로 한-미 디커플링 진행 중 — 한국 비중은 유지.
...
### 핵심 이벤트: GTC 마감 + Samsung-AMD HBM4 MoU + Micron 실적 + TeraFab D-2

**GTC 2026 마감(3/19).** Samsung-AMD **HBM4 MoU** 체결. Micron **EPS $8.42**, HBM 매진. 반도체 시장 **$1조** 돌파 전망. 테슬라 **TeraFab 3/21 런칭 D-2**.

| 항목 | 내용 | 투자 시사점 |
|------|------|-----------|
| **★★ Samsung-AMD HBM4 MoU** | **MI455X용 HBM4 공급. 1c DRAM+4nm 로직, 3.3TB/s. 파운드리 협력** | **삼성 HBM 점유율 확대** |
| **★★ Micron EPS $8.42** | **HBM 2026년 말까지 매진. AI 메모리 슈퍼사이클** | **메모리 최강 섹터 확인** |
| **★ GTC 마감** | **Healthcare AI(Open-H, GR00T-H), 파트너 어워드, 오픈 프론티어 모델** | **GTC 촉매 소화 완료** |
| **★ CPO 양산 시작** | 2026년 변곡점, 연간 137% 성장 | AI 네트워크 새 투자 테마 |
| **반도체 $1T** | **SIA 2026년 $1조 돌파 전망. 메모리 핵심 동력** | 기가사이클 가속 |
| **HBM4: SK하이닉스 70%** | HBM4 양산 개시, 70% 점유(UBS). 삼성 AMD MoU로 추격 | SK 1위, 삼성 추격 |
| **★ TeraFab D-2** | **테슬라 $25B 자체 팹. 2nm. 3/21 런칭** | **NVDA/TSMC 장기 경쟁 변수** |
| **NVDA $180.40** | **-0.84% FOMC 여파. SOXX 338.29(-0.58%)** | **단기 조정, 펀더멘탈 견조** |
...
### 이란 가스전 공습 Brent $110 + 원전 르네상스

| 항목 | 내용 |
|------|------|
| **★★★ 이란 가스전 공습** | **이스라엘, 이란 최대 가스전(South Pars) 공습. Brent ~$110(+5%), WTI ~$98** |
| **★★ Brent-WTI $10** | **스프레드 $10(정상 $2-5). 해상 공급 스트레스 사상 최대** |
| **★★ Larijani 피살** | **이란 안보수장 사망. 이란 보복 맹세** |
| **★ 석유시설 위협** | **이란, 사우디·UAE·카타르 석유시설 위협** |
| **Goldman 상향** | **이란 전쟁 에스컬레이션 반영 유가 전망 상향** |
...
| 시나리오 | 유가 전망 | 확률 | 영향 |
|---------|----------|------|------|
| **휴전/부분 해제** | **$70~85** | **극저 (15%)** | **★ 이란 가스전 공습→휴전 확률 급감** |
| **현상 유지 (선별 봉쇄)** | **$95~110** | **중 (35%)** | **Brent $110 수준. 레인지 상향** |
| **★ 봉쇄 장기화 + 보복 확대** | **$110~160** | **★ 중-고 (45%)** | **★★ 이란 가스전 공습+Larijani 피살→에스컬레이션 확률 최고** |
| 이란 체제 전환 성공 | $55~65 | 극저 (5%) | 유가 하락, 리스크 프리미엄 완전 해소 |

**시나리오 변화:** 이스라엘의 **이란 최대 가스전(South Pars) 공습 + Larijani 피살**로 시나리오 대폭 변경. **봉쇄 장기화+보복 확대 확률 25%→45% 급상향**, 휴전 확률 **30%→15% 급감**. Brent **~$110**, Brent-WTI 스프레드 **$10**(정상 $2-5)로 해상 공급 교란 사상 최대. 이란이 사우디·UAE·카타르 석유시설까지 위협 — 걸프 전체 에너지 인프라 리스크. Goldman 유가 전망 상향. **유가 $100+ 고착화** 확정적.
...
| 자산 | 현재 | 전망 | 포지션 |
|------|------|------|--------|
| **금(Gold)** | **~$5,030/oz** (+0.3%) | **Larijani 피살→안전자산. Goldman $6,000 장기 타겟** | **적극 매수** |
| **은(Silver)** | 강세 유지 | $100 전망, 6년 연속 공급적자 | **분할 매수** |
| **비트코인** | **$71,082** (-3.84%) | **★ FOMC 매파+유가→위험자산 기피** | **소규모 유지** |

**금 판단:** ~$5,030으로 **$5K 위 유지**. 이란 안보수장 **Larijani 피살** + FOMC 매파 동결로 **이중 안전자산 수요**. Goldman **$6,000 장기 타겟**. 사모신용 위기 지속 + 이란 전쟁 에스컬레이션이 안전자산 수요 구조적 강화. **비중 12% 유지**.

**비트코인 판단:** $71,082(-3.84%)로 **하락**. FOMC 매파 + 유가 $110으로 **위험자산 기피** 확대. 그러나 Druckenmiller의 **"15년 내 스테이블코인이 글로벌 결제 대세"** 전망 + 장기 탈중앙화 수요 근거는 유효. 레버리지 금지, **소규모 유지**.
...
### KOSPI: 5,777(+2.42%) — 급등 + EWY 1W +6.79% 글로벌 최강

2/26 사상최고(6,307) → 3/4 -12.64%(사상 최대 폭락) → 3/11 +8.28% 대반등 → 3/17 5,683(+3.57%) → 3/18 5,550(+1.14%) → **3/19 5,777(+2.42%)** 급등. EWY 1W **+6.79%**, 3M **+47.32% 글로벌 최강**. Goldman 연말 목표 **7,000**.

| 항목 | 3/4 | 3/5 | 3/10 | 3/11 | 3/12 | 3/13 | 3/16 | 3/17 | 3/18 | 3/19 |
|------|------|------|------|------|------|------|------|------|------|------|
| **KOSPI** | -12.64% | +9.63% | -5.96% | +8.28% | -0.48% | -1.72% | +0.75% | +3.57% | +1.14% | **+2.42% (5,777)** |
| **핵심** | 서킷브레이커 | 반등 | 추가 하락 | 대반등 | 보합 | 급락 | GTC 개막 | 대반등 | 상승 | **★ 급등** |
...
### 핵심 전략: "FOMC 매파 + 이란 가스전 공습 + S&P 하락 → 방어 강화 + 에너지 상향"

3월 19일 기준 핵심 전략:

1. **FOMC 매파 동결**: PPI +0.7%(예상 2배). 점도표 1회 인하만. **현금 16% 축소 보류**
2. **이란 가스전 공습**: Brent $110, WTI $98. Brent-WTI 스프레드 $10. Larijani 피살. **에너지 14%→15% 상향**
3. **S&P 6,624(-1.36%)**: 4개월래 최저. Dow -750pt. 200일선(6,589) 근접. **바닥 형성 약화**
4. **Samsung-AMD HBM4 MoU**: 삼성 HBM4 공급 + 파운드리 협력. **삼성 반도체 신뢰도 회복**
5. **Micron EPS $8.42**: HBM 매진. AI 메모리 슈퍼사이클. **반도체 20% 유지**
6. **KOSPI 5,777(+2.42%)**: 삼성 +2.83%, SK +7.03%. 미-한 디커플링. **한국 비중 유지**
7. **방산 최강 지속**: 이란 에스컬레이션→방산 수혜. Rheinmetall +45%. **방산 24% 유지**
8. **GTC 마감**: 3일간 주요 발표 소화 완료. **TeraFab 3/21(D-2)로 관심 이동**
9. **이번 주 핵심**: **TeraFab 3/21**, S&P 리밸런싱(3/23), 트럼프-시진핑(3월 말)
10. **리스크**: S&P 200일선 이탈 시 추가 하락, 이란 보복→유가 $130+, PPI→CPI 전이
...
**FOMC 매파 동결 + 이란 가스전 공습 Brent $110 + S&P -1.36% → 방어 강화, 에너지 소폭 상향**

#### 전일 대비 변동 (3/19 vs 3/18)

| 섹터 | 전일 비중 | 금일 비중 | 변동 | 변동 사유 |
|------|----------|----------|------|----------|
| AI/반도체 | 20% | 20% | - | Samsung-AMD HBM4 MoU. Micron EPS $8.42. SOXX -0.58% 단기 조정 |
| 방산/조선 | 24% | 24% | - | 이란 에스컬레이션→방산 수혜 강화. Rheinmetall +45% |
| 에너지/원전 | 14% | **15%** | **+1%** | **★ Brent $110 이란 가스전 공습. 유가 $100+ 고착화** |
| 금 | 12% | 12% | - | ~$5,030, Larijani 피살→안전자산. Goldman $6,000 |
| 은 | 2% | 2% | - | $100 전망, 6년 공급적자 |
| 로봇/자율주행 | 6% | **5%** | **-1%** | **테슬라 15번째 사고. FOMC 매파→성장주 조정** |
| AI 네트워크/CPO | 4% | 4% | - | CPO 변곡점. GTC 마감. TeraFab D-2 |
| STO/핀테크 | 0% | 0% | - | 사모신용 위기→사실상 제외 |
| 현금 | 16% | 16% | - | **FOMC 매파+PPI핫→현금 축소 보류. 200일선 근접 경계** |
| 바이오/헬스 | 2% | 2% | - | Healthcare PE 26.2. 방어적 포지션 유지 |

#### 추천 종목 (실제 종목/ETF)

| 섹터 | 추천 종목 (티커) | 추천 사유 | 현재가/밸류에이션 |
|------|----------------|----------|-----------------|
| AI/반도체 | SK하이닉스, 삼성전자, NVDA, SOXX(ETF), Micron(MU) | **Samsung-AMD HBM4 MoU. Micron EPS $8.42, HBM 매진** | NVDA $180.40, SOXX 338.29 |
| 방산/조선 | 한화에어로스페이스, LIG넥스원, HD한국조선해양, ITA(ETF) | **이란 에스컬레이션→방산 수혜. Rheinmetall +45%** | 방산 최강 섹터 |
| 에너지/원전 | 두산에너빌리티, Cameco(CCJ), NuScale(SMR), XLE(ETF) | **★ Brent $110 이란 가스전 공습. 원전 $80B** | Brent ~$110 |
| AI 네트워크/CPO | **Marvell(MRVL)**, Credo(CRDO), Eaton(ETN) | **CPO 변곡점. GTC 마감. TeraFab D-2** | MRVL 고점 -30% |
| 금 | GLD, IAU, KODEX 골드선물(H) | **~$5,030, Larijani 피살→안전자산, Goldman $6,000** | ~$5,030 |
| 은 | SLV, PSLV, 고려아연 | **$100 전망, 6년 공급적자** | 공급적자 구조 |
| 로봇/자율주행 | 테슬라(TSLA), Waymo(GOOGL), 두산로보틱스, BOTZ(ETF) | **LG에너지 $4.3B LFP 계약. 로보택시 마진 78%** | BOTZ 34.85 |
...
| 섹터 | 비중 | 근거 |
|------|------|------|
| **AI/반도체 (HBM·메모리)** | **20%** | **Samsung-AMD HBM4 MoU. Micron EPS $8.42. $1T 기가사이클** |
| **방산/조선** | **24%** | **이란 에스컬레이션→방산 수혜. Rheinmetall +45%. 한국 +131% YoY** |
| **에너지/원전** | **15%** | **★ Brent $110 이란 가스전 공습. 유가 $100+ 고착화. 원전 $80B** |
| **금** | **12%** | **~$5,030, Larijani 피살→안전자산, Goldman $6,000** |
| **은** | **2%** | **$100 전망, 6년 공급적자** |
| 로봇/자율주행 | **5%** | **LG에너지 $4.3B LFP. 로보택시 마진 78%. 사이버캡 4월** |
| AI 네트워크/CPO | 4% | CPO 변곡점, GTC 마감, TeraFab D-2 |
| 바이오/헬스 | **2%** | **방어적 매력, PE 26.2** |
| **현금** | **16%** | **FOMC 매파+PPI핫→축소 보류. S&P 200일선 근접 경계** |
...
| 일정 | 이벤트 | 투자 시사점 |
|------|--------|------------|
| **3/16~19** | **NVIDIA GTC 2026 마감** | **Healthcare AI, 파트너 어워드, 오픈 프론티어 모델** |
| **3/17~18** | **★★ FOMC 매파 동결 완료** | **PPI +0.7%. 1회 인하만. S&P -1.36%** |
...
**2026년 3월 19일, FOMC 매파 동결 + 이란 가스전 공습 Brent $110 + S&P 6,624(-1.36%). 방어 강화, 에너지 상향.**

1. **FOMC 매파 동결** — PPI +0.7%(예상 2배). 점도표 1회 인하만(20bp). S&P -1.36% 4개월래 최저. 200일선(6,589) 근접
2. **이란 가스전 공습** — 이스라엘, South Pars 공습. Brent ~$110(+5%), WTI ~$98. Brent-WTI 스프레드 $10. Larijani 피살
3. **Samsung-AMD HBM4 MoU** — MI455X용 HBM4 공급. 1c DRAM+4nm 로직, 3.3TB/s. 파운드리 협력 논의
4. **Micron EPS $8.42** — HBM 2026년 말까지 매진. AI 메모리 슈퍼사이클 최종 확인
5. **KOSPI 5,777(+2.42%)** — 삼성 +2.83%, SK +7.03%. EWY 1W +6.79% 글로벌 최강. 미-한 디커플링
6. **사모신용 위기 지속** — 부도율 9.2% 사상 최고. FOMC 매파→리파이낸싱 부담 가중
7. **GTC 마감 + TeraFab D-2** — 3일간 주요 발표 소화. 3/21 TeraFab 런칭으로 관심 이동

**투자 환경:** 반도체 20%, 방산 24%, 에너지 **15%(+1%)**, 금 12%, CPO 4%, 로봇 **5%(-1%)**, 현금 16%. **FOMC 매파+이란 에스컬레이션**으로 방어 강화 — 에너지 소폭 상향, 현금 축소 보류. S&P 200일선 근접이 **핵심 관전 포인트** — 이탈 시 추가 하락, 지지 시 반등 기회.

### 3월 기준 섹터 우선순위

| 순위 | 섹터 | 근거 | 포지션 |
|------|------|------|--------|
| **1위** | **방산/조선** | **이란 에스컬레이션, CAPEX +38%, Rheinmetall +45%, NATO 5% GDP** | **적극 매수** |
| **2위** | **금/은** | **~$5,030, Larijani 피살→안전자산. FOMC 매파→금리 장기화→금 수혜** | **적극 매수** |
| **3위** | **AI/반도체 (메모리·HBM)** | **Samsung-AMD HBM4 MoU, Micron EPS $8.42, HBM 매진** | **분할 매수** |
| **4위** | **에너지/원전** | **★ Brent $110 이란 가스전 공습. 유가 $100+ 고착화** | **상향 (15%)** |
| **5위** | **AI 네트워크/CPO** | **CPO 변곡점, 137% 성장, GTC 마감, TeraFab D-2** | **유지** |
| 6위 | **배당 ETF** | 월배당 20%+, FOMC 매파→변동성 방어 | **필수 편입** |
| 7위 | **로봇/자율주행** | LG에너지 $4.3B LFP, 로보택시 마진 78%, 사이버캡 4월 | 유지 |
| 8위 | **바이오/헬스** | 방어 섹터 매력 | 유지 |
| - | **암호화폐** | BTC $71,082 (-3.84%), 위험자산 기피 | **소규모 유지** |

### 핵심 투자 원칙

1. **FOMC 매파 동결** — PPI +0.7%(예상 2배). 점도표 1회 인하만. S&P -1.36%. **현금 16% 축소 보류**
2. **이란 가스전 공습** — Brent $110, Brent-WTI 스프레드 $10. Larijani 피살. **에너지 14%→15% 상향**
3. **S&P 200일선 근접** — 6,624, 200일선(6,589)까지 35pt. **이탈 시 추가 하락 리스크**. 현금 유지
4. **사모신용 위기 지속** — 부도율 9.2%. FOMC 매파→리파이낸싱 부담 가중. **금 12%, 금융주 경계**
5. **Samsung-AMD HBM4 MoU** — 삼성 HBM 신뢰도 회복. Micron HBM 매진. **반도체 20% 유지**
6. **KOSPI 디커플링** — 5,777(+2.42%), EWY 1W +6.79%. 미국 하락에도 한국 급등. **한국 비중 유지**
7. **이번 주 핵심 이벤트** — **TeraFab 3/21**, S&P 500 리밸런싱(3/23), 트럼프-시진핑(3월 말)
8. **리스크 관리** — 이란 보복→유가 $130+, PPI→CPI 전이, S&P 200일선 이탈. **방어적 스탠스 유지**
