---
layout: post
title: "2026년 에너지 섹터 투자 전망: Brent $106(-6.2%)·트럼프 '석기시대'+수주 내 종료 모순·호르무즈 4/6 데드라인·테슬라Q1 ESS miss·유럽EV 폭증 (4월 3일 업데이트)"
...
description: "2026년 에너지 섹터 종합 투자 전망. Brent $105.58(-6.2%), WTI $103.36(-1.3%). 트럼프 '석기시대+수주 내 종료' 모순 발언→유가 조정. 호르무즈 4/6 데드라인 핵심. 테슬라 Q1 ESS 8.8GWh(예상 14.4GWh 대폭 miss). 유럽 EV 폭증(프랑스+203%, 노르웨이+178%). 3월 Brent 55% 상승 역사적 기록 후 조정."
...
## 4/3 핵심 요약: Brent $106(-6.2%)·트럼프 "석기시대" + "수주 내 종료" 모순·4/6 데드라인·유럽 EV 폭증

Brent가 **$105.58(-6.2%)**, WTI **$103.36(-1.3%)**로 조정되었습니다. 3월 **55% 상승(역사적 기록)** 후 하락 전환. 트럼프가 전국민 연설에서 **"이란을 석기시대로 보낼 것"**, **"2-3주 내 극강 타격"**을 선언하면서도 동시에 **"전쟁 수주 내 종료 가능"** 발언 — **발언과 군사행동의 모순**이 유가 하락을 촉발. JP모건은 해병대·A-10 배치로 **지상전 가능성(10%)**을 경고. 이란은 "100년 전쟁도 불사" 맞대응.

**4월 6일 호르무즈 데드라인**이 핵심 바이너리 리스크. Macquarie 시나리오: 전면 봉쇄 시 **$200**, 돌파 시 **$80-90**. XLE **$59.25(+0.47%)**. 테슬라 Q1 ESS **8.8GWh**(예상 14.4GWh **대폭 miss**, -38% QoQ). 유럽 EV 폭증 — 프랑스 **+203%**, 노르웨이 **+178%**, 스웨덴 **+144%**. 유가 급등(리터당 2유로)→EV 전환 경제성 극대화. 기가 베를린 가동률 **90%+**. 페트로위안 구조적 전환 지속.

| 항목 | 4/2 | **4/3** | 변화 |
|------|------|---------|------|
| **WTI** | $104.69 | **$103.36 (-1.3%)** | "수주 내 종료" 발언→소폭 하락 |
| **Brent** | $112.57 | **$105.58 (-6.2%)** | ★ 3월 55% 상승 후 조정 전환 |
| **핵심 이벤트** | 4/6 데드라인 + 바이너리 시나리오 | **트럼프 "석기시대" + 지상전 가능성 10%** | 에스컬레이션 최고조 |
