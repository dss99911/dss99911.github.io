---
layout: post
title: "2026년 거시경제/정책 투자 전망 (4월 2일 업데이트): 휴전 기대·RRP 제로 피크유동성·금 $4,815 반등·KOSPI 5,545 역사적 반등·10Y 4.30%·DXY 하락·BTC $68,250·VIX 25·환율 1,510원·Ken Fisher 3단계 회복 국면"
...
description: "2026년 4월 2일 기준 거시경제 환경 분석. 휴전 기대 + RRP $2.1B(거의 ZERO) 피크 유동성 + KOSPI 5,545(+9.75%) 역사적 반등 = 리스크온 전환. 금 $4,815(+3.6%, 1W +10.05%) JPM $6,300 목표가. 10Y 4.30%(-1.15%), VIX 25.25(-17.5%). Ken Fisher 3단계 전쟁 패턴 Stage 2-3 회복 국면. 환율 1,510원, WGBI 편입 수혜. 단 4/6 호르무즈 데드라인이 바이너리 리스크."
...
2026년 4월 2일(수) 기준 업데이트입니다. **핵심 테마는 휴전 기대 + 피크 유동성(RRP 제로) + KOSPI 역사적 저평가 반등 = 리스크온 전환**이며, **4월 6일 호르무즈 데드라인이 바이너리 리스크**로 남아 있습니다.

3월 말 극도 공포(VIX 30+, F&G 13, KOSPI -12% 블랙튜즈데이) 국면에서 **급격한 센티먼트 반전**이 진행 중입니다. 금이 $4,815로 1주일 만에 +10.05% 급등하며 Golden Paradox에서 벗어나고 있고, KOSPI는 5,545(+9.75%)로 삼성전자 +14%, SK하이닉스 +10%의 강력한 반등을 보여주고 있습니다. **Ken Fisher의 3단계 전쟁 패턴(Stage 2→3: 최악 선반영 → 회복)**이 현실화되는 양상입니다.

**RRP $2.1B**로 사실상 ZERO에 도달하여 **피크 유동성 주입** 상태이며, 이는 시장 하방을 강력히 지지합니다. 다만 **4월 6일 호르무즈 해협 데드라인**이 휴전/확전의 분기점으로, 결과에 따라 시장 방향이 극단적으로 갈릴 수 있는 **바이너리 리스크**입니다.

## 시장 현황 (2026년 4월 2일 기준)

### 핵심 매크로 지표

| 항목 | 현황 | 변동/방향 |
|------|------|-----------|
| **★ Fed 금리** | **3.50-3.75% 동결** | **인플레 불확실성 지속, 인상 임박하지 않음** |
| **★ 10Y 국채** | **4.30%** | **-1.15% — 금리 하락 (리스크온)** |
| **★ 2Y 국채** | **3.79%** | **-0.79% — 단기 금리도 하락** |
| **★ 10Y-2Y 스프레드** | **0.52%** | **정상적 스티프닝 유지** |
| **★ VIX** | **25.25** | **-17.5% — 공포 급감, 리스크온** |
...
| 항목 | 현황 | 변동 |
|------|------|------|
| **★ 금(Gold)** | **$4,815/oz** | **+3.6%, 1W +10.05% — 강력 반등** |
| **★ KOSPI** | **5,545** | **+9.75% — 역사적 반등** |
| **★ DXY** | **1W -0.32%** | **달러 약세 전환** |
| **★ 비트코인** | **$68,250** | **상대적 안정** |
| **★ USD/KRW** | **1,509.86** | **WGBI 편입 → KRW 강세 기대** |

### ★ 글로벌 자금 흐름: 한국·일본 리스크온 리더

| 지역/자산 | 1W 수익률 | 방향 |
|----------|-----------|------|
| **★ Korea (EWY)** | **+5.19%** | **글로벌 최고** |
| **Japan** | **+4.56%** | 아시아 강세 |
| **Europe** | **+4.32%** | 리스크온 동참 |
| **US** | **+1.57%** | 상대적 약세 |
| **India** | **+0.21%** | 소폭 |
...
```mermaid
graph TD
    A["휴전 기대 + 4/6 호르무즈 데드라인"] --> B["전쟁 최악 선반영"]
    B --> C["Ken Fisher Stage 2→3 회복"]
    D["RRP $2.1B #40;사실상 ZERO#41;"] --> E["피크 유동성 주입"]
    E --> F["시장 하방 강력 지지"]
    C --> G["★ 리스크온 전환"]
    F --> G
    G --> H["KOSPI +9.75% #40;삼성 +14%, 하이닉스 +10%#41;"]
    G --> I["금 $4,815 #40;1W +10.05%#41;"]
    G --> J["VIX 25.25 #40;-17.5%#41;"]
    G --> K["HY Spread 3.28% #40;-5.2%#41;"]
    L["4/6 호르무즈 데드라인"] --> M{"바이너리 리스크"}
    M -->|"휴전"| N["유가 하락 → 인플레 완화 → 금리인하 → 강세장"]
    M -->|"확전"| O["유가 $150+ → 스태그플레이션 심화"]
```
