...
redirect_from:
  - "/programming/common/2025/12/28/programming-language-cheatsheet.html"
---

# 프로그래밍 언어 비교 치트시트

여러 언어를 오가다 보면 변수 선언이나 반복문 같은 기본 문법이 헷갈릴 때가 있습니다. Python, Kotlin, JavaScript의 문법을 나란히 비교해 빠르게 찾아볼 수 있게 정리했습니다.
...
기본 문법 비교용이라 자세한 동작은 각 언어 공식 문서를 함께 살펴보면 좋습니다.
