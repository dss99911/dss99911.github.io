---
layout: post
title: "Arabic Alphabet Complete Guide - Letters, Forms, and Pronunciation"
date: 2026-01-11
...
1. **ب (ba)** - Has a dot at the **b**ottom
2. **ت (ta)** - Has **t**wo dots above
3. **ث (tha)** - Has **th**ree dots above
4. **ج (jim)** - Z-shaped, dot below
5. **س (sin)** - Looks like number 3, for "**s**in"
