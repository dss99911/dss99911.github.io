---
layout: post
title: "Indonesian Essential Grammar - Negation, Passive, Comparatives, and More"
date: 2026-01-11
...
Active: Dia tidak akan membeli mobil.
Passive: Mobil tidak akan dibeli (oleh) dia.
...
- Mobil ini tidak terbeli karena harganya mahal
  (This car wasn't bought because it was expensive)
...
|---------|----------|---------|
| buah | general objects | 1 buah apel (1 apple) |
| butir | small round things | 1 butir telur (1 egg) |
| potong | pieces/slices | 1 potong kue (1 piece of cake) |
| gelas | glasses/cups | 1 gelas kopi (1 cup of coffee) |
...
- Kemarin saya membeli mobil mahal.
  Mobilnya bagus sekali. (The car is very nice)

### Double Subject
- Saya rambutnya panjang. (As for me, my hair is long)

### Adverb Formation
| Base | With -nya | Meaning |
|------|-----------|---------|
| biasa | biasanya | usually |
| seperti | sepertinya | it seems |
| akhir | akhirnya | finally |
| awal | awalnya | initially |
| sayang | sayangnya | unfortunately |
| untung | untungnya | fortunately |
| kata | katanya | they say |
...
When speaking directly to someone, use the simpler form.
When discussing others, use the me- form.
...
- Mengapa berteman dengan orang asing itu menarik?
  (Why is making friends with foreigners interesting?)

### Whether or not
- apakah...atau belum
- Aku tidak tahu apakah dia sudah makan atau belum.
  (I don't know whether he has eaten or not yet)
